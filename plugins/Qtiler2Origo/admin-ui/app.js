...
const QTWC_I18N = {
  en: {
    ...
    'Qtiler2Origo.subtitle': 'Install Origo from GitHub, publish QGIS maps visually, and manage access with or without QtilerAuth.',
    'Qtiler2Origo.how_title': 'How Qtiler2Origo works',
    'Qtiler2Origo.how_intro': 'Qtiler2Origo connects Qtiler to Origo, turning QGIS projects into configured web maps from one administration interface.',
    ...
    'Qtiler2Origo.how_step_share': 'Share maps — every published profile gets a stable direct link that can also be used by QtilerStories.',
    'Qtiler2Origo.how_step_brand': 'Brand and customise — upload a viewer logo and configure layers, backgrounds, search, editing and toolbar controls.',
    ...
    'Qtiler2Origo.legend_pick_qgis_svg': 'QGIS SVG icons',
    'Qtiler2Origo.legend_pick_uploaded': 'Uploaded icons',
    'Qtiler2Origo.legend_upload_new': 'Upload new…',
    'Qtiler2Origo.legend_pick_title': 'Choose legend icon',
    'Qtiler2Origo.legend_search_placeholder': 'Search icons…',
    'Qtiler2Origo.legend_delete_in_use': 'This icon is used by {n} layer(s) in the current map: {layers}. Delete it anyway?',
    'Qtiler2Origo.legend_delete_confirm': 'Delete this icon? It will no longer be available in the library.',
    'Qtiler2Origo.legend_current_map': 'current map',
    'Qtiler2Origo.draft_restore_title': 'Draft found',
    'Qtiler2Origo.draft_restore_msg': 'A saved draft exists for this map (saved {date}). Restore it and continue where you left off?',
    'Qtiler2Origo.draft_restore_yes': 'Restore draft',
    'Qtiler2Origo.draft_restore_no': 'Discard draft',
    'Qtiler2Origo.draft_restored': 'Draft restored.',
    'Qtiler2Origo.draft_save_failed': 'Could not save the draft: {msg}',
    'Qtiler2Origo.preflight_checks_title': 'Map check results',
    'Qtiler2Origo.lmv_demo_warning': 'Lantmäteriet Search returns DEMO data — no API key configured on the server (set LANTMATERI_API_KEY in .env).',
    'Qtiler2Origo.thumb_missing': 'No thumbnail',
    'Qtiler2Origo.unsaved_changes_confirm': 'You have unpublished changes in the map editor. Close anyway and lose them?',
    'Qtiler2Origo.choose_image': 'Choose image',
    'Qtiler2Origo.use_autogenerated': 'Use autogenerated',
    'Qtiler2Origo.custom': 'Custom',
    'Qtiler2Origo.no_assets': 'No uploaded images. Please go to Setup and upload some images first.',
    'Qtiler2Origo.upload_new': 'Upload new...',
    'Qtiler2Origo.choose_asset': 'Choose asset',
    ...
    'Qtiler2Origo.thumbnail_change': 'Change thumbnail',
    'Qtiler2Origo.thumbnail_setup_title': 'Map thumbnails',
    'Qtiler2Origo.thumbnail_setup_help': 'Replace an automatically generated thumbnail with your own image. Publishing the map again keeps this image; Regenerate thumbnail returns to automatic mode.',
    'Qtiler2Origo.thumbnail_setup_map': 'Published map',
    'Qtiler2Origo.thumbnail_setup_file': 'PNG, JPG or WEBP image',
    'Qtiler2Origo.thumbnail_setup_upload': 'Upload thumbnail',
    ...
    'Qtiler2Origo.json_import': 'Import JSON',
    'Qtiler2Origo.json_download': 'Download JSON',
    ...
    'Qtiler2Origo.wfs_format_json': 'Format JSON',
    ...
    'Qtiler2Origo.hiw.lead': 'Qtiler2Origo embeds the Origo web map viewer in Qtiler. It installs a selected GitHub release and lets administrators configure each published map graphically from QGIS.',
  ...
  es: {
    ...
    'Qtiler2Origo.subtitle': 'Instala Origo desde GitHub, publica mapas QGIS visualmente y gestiona el acceso con o sin QtilerAuth.',
    'Qtiler2Origo.how_title': 'Cómo funciona Qtiler2Origo',
    'Qtiler2Origo.how_intro': 'Qtiler2Origo conecta Qtiler con Origo y convierte proyectos QGIS en mapas web configurados desde una sola interfaz de administración.',
    ...
    'Qtiler2Origo.how_step_share': 'Comparte mapas: cada perfil publicado obtiene un enlace directo estable que también puede usar QtilerStories.',
    'Qtiler2Origo.how_step_brand': 'Personaliza el visor: sube un logotipo y configura capas, fondos, búsqueda, edición y controles de la barra.',
    ...
    'Qtiler2Origo.legend_pick_qgis_svg': 'SVG de QGIS',
    'Qtiler2Origo.legend_pick_uploaded': 'Iconos subidos',
    'Qtiler2Origo.legend_upload_new': 'Subir nuevo…',
    'Qtiler2Origo.legend_pick_title': 'Elegir icono de leyenda',
    'Qtiler2Origo.legend_search_placeholder': 'Buscar iconos…',
    'Qtiler2Origo.legend_delete_in_use': 'Este icono lo usan {n} capa(s) del mapa actual: {layers}. ¿Eliminarlo de todos modos?',
    'Qtiler2Origo.legend_delete_confirm': '¿Eliminar este icono? Ya no estará disponible en la biblioteca.',
    'Qtiler2Origo.legend_current_map': 'mapa actual',
    'Qtiler2Origo.draft_restore_title': 'Borrador encontrado',
    'Qtiler2Origo.draft_restore_msg': 'Existe un borrador guardado de este mapa (guardado {date}). ¿Restaurarlo y continuar donde lo dejaste?',
    'Qtiler2Origo.draft_restore_yes': 'Restaurar borrador',
    'Qtiler2Origo.draft_restore_no': 'Descartar borrador',
    'Qtiler2Origo.draft_restored': 'Borrador restaurado.',
    'Qtiler2Origo.draft_save_failed': 'No se pudo guardar el borrador: {msg}',
    'Qtiler2Origo.preflight_checks_title': 'Resultados de la comprobación',
    'Qtiler2Origo.lmv_demo_warning': 'La búsqueda de Lantmäteriet devuelve datos DEMO: no hay clave de API configurada en el servidor (define LANTMATERI_API_KEY en .env).',
    'Qtiler2Origo.thumb_missing': 'Sin miniatura',
    'Qtiler2Origo.unsaved_changes_confirm': 'Tienes cambios sin publicar en el editor de mapa. ¿Cerrar de todos modos y perderlos?',
    'Qtiler2Origo.choose_image': 'Elegir imagen',
    'Qtiler2Origo.use_autogenerated': 'Usar autogenerada',
    'Qtiler2Origo.custom': 'Personalizada',
    'Qtiler2Origo.no_assets': 'No hay imágenes subidas. Por favor ve a Setup y sube algunas imágenes primero.',
    'Qtiler2Origo.upload_new': 'Subir nueva...',
    'Qtiler2Origo.choose_asset': 'Elegir recurso',
    ...
    'Qtiler2Origo.thumbnail_change': 'Cambiar miniatura',
    'Qtiler2Origo.thumbnail_setup_title': 'Miniaturas de mapas',
    'Qtiler2Origo.thumbnail_setup_help': 'Reemplaza la miniatura automática con una imagen propia. Volver a publicar conserva esta imagen; Regenerar miniatura vuelve al modo automático.',
    'Qtiler2Origo.thumbnail_setup_map': 'Mapa publicado',
    'Qtiler2Origo.thumbnail_setup_file': 'Imagen PNG, JPG o WEBP',
    'Qtiler2Origo.thumbnail_setup_upload': 'Subir miniatura',
    ...
    'Qtiler2Origo.json_import': 'Importar JSON',
    'Qtiler2Origo.json_download': 'Descargar JSON',
    ...
    'Qtiler2Origo.wfs_format_json': 'Formatear JSON',
    ...
    'Qtiler2Origo.hiw.lead': 'Qtiler2Origo integra el visor web Origo en Qtiler. Instala una versión seleccionada desde GitHub y permite configurar gráficamente cada mapa publicado desde QGIS.',
    'Qtiler2Origo.hiw.vs.title': 'Qrigo vs Qtiler2Origo',
  ...
  sv: {
    ...
    'Qtiler2Origo.subtitle': 'Installera Origo från GitHub, publicera QGIS-kartor visuellt och hantera åtkomst med eller utan QtilerAuth.',
    'Qtiler2Origo.how_title': 'Så fungerar Qtiler2Origo',
    'Qtiler2Origo.how_intro': 'Qtiler2Origo kopplar Qtiler till Origo och omvandlar QGIS-projekt till konfigurerade webbkartor från ett administrationsgränssnitt.',
    ...
    'Qtiler2Origo.how_step_share': 'Dela kartor: varje publicerad profil får en stabil direktlänk som också kan användas av QtilerStories.',
    'Qtiler2Origo.how_step_brand': 'Varumärkesanpassa visaren: ladda upp en logotyp och konfigurera lager, bakgrunder, sökning, redigering och verktygsfält.',
    ...
    'Qtiler2Origo.legend_pick_qgis_svg': 'QGIS SVG-ikoner',
    'Qtiler2Origo.legend_pick_uploaded': 'Uppladdade ikoner',
    'Qtiler2Origo.legend_upload_new': 'Ladda upp ny…',
    'Qtiler2Origo.legend_pick_title': 'Välj legendikon',
    'Qtiler2Origo.legend_search_placeholder': 'Sök ikoner…',
    'Qtiler2Origo.legend_delete_in_use': 'Denna ikon används av {n} lager i aktuell karta: {layers}. Ta bort den ändå?',
    'Qtiler2Origo.legend_delete_confirm': 'Ta bort denna ikon? Den kommer inte längre att finnas i biblioteket.',
    'Qtiler2Origo.legend_current_map': 'aktuell karta',
    'Qtiler2Origo.draft_restore_title': 'Utkast hittat',
    'Qtiler2Origo.draft_restore_msg': 'Ett sparat utkast finns för denna karta (sparad {date}). Återställa det och fortsätta där du slutade?',
    'Qtiler2Origo.draft_restore_yes': 'Återställ utkast',
    'Qtiler2Origo.draft_restore_no': 'Kassera utkast',
    'Qtiler2Origo.draft_restored': 'Utkast återställt.',
    'Qtiler2Origo.draft_save_failed': 'Kunde inte spara utkastet: {msg}',
    'Qtiler2Origo.preflight_checks_title': 'Resultat av kartkontroll',
    'Qtiler2Origo.lmv_demo_warning': 'Lantmäteriet-sökning returnerar DEMO-data — ingen API-nyckel konfigurerad på servern (sätt LANTMATERI_API_KEY i .env).',
    'Qtiler2Origo.thumb_missing': 'Ingen miniatyr',
    'Qtiler2Origo.unsaved_changes_confirm': 'Du har opublicerade ändringar i kartredigeraren. Stäng ändå och förlora dem?',
    'Qtiler2Origo.choose_image': 'Välj bild',
    'Qtiler2Origo.use_autogenerated': 'Använd automatisk',
    'Qtiler2Origo.custom': 'Anpassad',
    'Qtiler2Origo.no_assets': 'Inga uppladdade bilder. Gå till fliken Setup och ladda upp bilder först.',
    'Qtiler2Origo.upload_new': 'Ladda upp ny...',
    'Qtiler2Origo.choose_asset': 'Välj resurs',
    ...
    'Qtiler2Origo.thumbnail_change': 'Byt miniatyrbild',
    'Qtiler2Origo.thumbnail_setup_title': 'Kartminiatyrer',
    'Qtiler2Origo.thumbnail_setup_help': 'Ersätt den automatiska miniatyren med en egen bild. Ny publicering behåller bilden; Skapa om miniatyr återgår till automatiskt läge.',
    'Qtiler2Origo.thumbnail_setup_map': 'Publicerad karta',
    'Qtiler2Origo.thumbnail_setup_file': 'PNG-, JPG- eller WEBP-bild',
    'Qtiler2Origo.thumbnail_setup_upload': 'Ladda upp miniatyr',
    ...
    'Qtiler2Origo.json_import': 'Importera JSON',
    'Qtiler2Origo.json_download': 'Ladda ner JSON',
    ...
    'Qtiler2Origo.wfs_format_json': 'Formatera JSON',
    ...
    'Qtiler2Origo.hiw.lead': 'Qtiler2Origo bäddar in webbkartvisaren Origo i Qtiler. Den installerar en vald GitHub-release och låter administratörer konfigurera varje publicerad karta grafiskt från QGIS.',
    'Qtiler2Origo.hiw.vs.title': 'Qrigo vs Qtiler2Origo',
...
QTWC_I18N.no = Object.assign({}, QTWC_I18N.sv, {
  ...
  'Qtiler2Origo.subtitle': 'Installer Origo fra GitHub, publiser QGIS-kart visuelt og administrer tilgang med eller uten QtilerAuth.',
  'Qtiler2Origo.hiw.button': 'Slik fungerer det og sikkerhet',
  'Qtiler2Origo.tab_setup': 'Oppsett',
  'Qtiler2Origo.tab_maps': 'Kart',
  'Qtiler2Origo.tab_log': 'Logg',
  'Qtiler2Origo.profiles_section': 'Publiserte kart',
  'Qtiler2Origo.profiles_desc': 'Administrer genererte profiler og startlenker for Origo (webkart).',
  'Qtiler2Origo.publish_new': 'Nytt kart',
  'Qtiler2Origo.open_viewer': 'Galleri for publiserte kart',
...
QTWC_I18N.da = Object.assign({}, QTWC_I18N.sv, {
  'Qtiler2Origo.title': 'Origo-bro til Qtiler',
  'Qtiler2Origo.subtitle': 'Installer Origo fra GitHub, publicér QGIS-kort visuelt, og administrer adgang med eller uden QtilerAuth.',
  'Qtiler2Origo.hiw.button': 'Sådan fungerer det og sikkerhed',
  'Qtiler2Origo.tab_setup': 'Opsætning',
  'Qtiler2Origo.tab_maps': 'Kort',
  'Qtiler2Origo.tab_log': 'Log',
  'Qtiler2Origo.profiles_section': 'Publicerede kort',
  'Qtiler2Origo.profiles_desc': 'Administrer genererede profiler og startlinks til Origo (webkort).',
  'Qtiler2Origo.publish_new': 'Nyt kort',
  'Qtiler2Origo.open_viewer': 'Galleri for publicerede kort',
...
QTWC_I18N.fi = Object.assign({}, QTWC_I18N.en, {
  'Qtiler2Origo.title': 'Origo-silta Qtilerille',
  'Qtiler2Origo.subtitle': 'Asenna Origo GitHubista, julkaise QGIS-karttoja visuaalisesti ja hallitse käyttöoikeuksia QtilerAuthin kanssa tai ilman sitä.',
  'Qtiler2Origo.hiw.button': 'Miten se toimii ja turvallisuus',
  'Qtiler2Origo.tab_setup': 'Asetukset',
  'Qtiler2Origo.tab_maps': 'Kartat',
  'Qtiler2Origo.tab_log': 'Loki',
  'Qtiler2Origo.profiles_section': 'Julkaistut kartat',
  'Qtiler2Origo.profiles_desc': 'Hallitse Origon (verkkokartan) luotuja profiileja ja avauslinkkejä.',
  'Qtiler2Origo.publish_new': 'Uusi kartta',
  'Qtiler2Origo.open_viewer': 'Julkaistujen karttojen galleria',
...
function renderPublishedProfiles(items) {
  ...
  publishedProfilesList.innerHTML = rows.map((row) => {
    ...
    const thumbMissingBadge = thumbUrl ? '' : `<span class="badge badge--warning" title="${escapeHtml(t('Qtiler2Origo.regen_thumb_title'))}">⚠ ${escapeHtml(t('Qtiler2Origo.thumb_missing'))}</span>`;
    return `
      <article class="published-item">
        ...
        <div class="published-item__content">
          ...
          <div class="actions">
            ...
            <button class="button ghost small" data-manual-thumb="${profileKey}">${escapeHtml(t('Qtiler2Origo.thumbnail_change'))}</button>
...
async function loadStatus() {
  ...
  if (currentStatus?.lantmateriDemo && !loadStatus._lmvWarned) {
    ...
    addLog('⚠ ' + t('Qtiler2Origo.lmv_demo_warning'), 'error');
  }
}
...
function renderThumbnailSetup(preferredProfileKey = '') {
  ...
  thumbnailProfileSelect.innerHTML = publishedItems.length
    ...
    : `<option value="">${escapeHtml(t('Qtiler2Origo.no_profiles'))}</option>`;
...
thumbnailUploadBtn?.addEventListener('click', async () => {
  ...
  try {
    ...
    await api(`/plugins/Qtiler2Origo/api/publish/thumbnail/${encodeURIComponent(profileKey)}/upload`, { method: 'POST', body });
...
function renderLayerChecklist(container, layers, rules = {}) {
  ...
  container.innerHTML = layers.map((layer) => {
    ...
    // effective symbology (WFS style / QGIS SVG / uploaded icon / WMS thumb).
    ...
    if (isVectorLayer) {
      ...
      // for WFS layers, legend icon picker for WMS layers).
      const mode = rule.serveAsWfs ? 'wfs' : 'wms';
      modeControls = `
        <div class="Qtiler2Origo-mode-switch" role="group" aria-label="WMS/WFS">
          <button type="button" class="Qtiler2Origo-mode-switch__btn${mode === 'wms' ? ' is-active' : ''}" data-layer-mode="wms" data-layer-key="${escapeHtml(layerKey)}">WMS</button>
          <button type="button" class="Qtiler2Origo-mode-switch__btn${mode === 'wfs' ? ' is-active' : ''}" data-layer-mode="wfs" data-layer-key="${escapeHtml(layerKey)}">WFS</button>
        </div>
        <button type="button" class="button is-small is-info is-light Qtiler2Origo-mode-switch__config" data-style-layer="${escapeHtml(layerKey)}">${rule.serveAsWfs
          ? (rule.wfsStyle ? t('Qtiler2Origo.wfs_style_yes') || 'Estilo WFS' : t('Qtiler2Origo.wfs_style_no') || 'Config. estilo')
          : escapeHtml(t('Qtiler2Origo.wms_legend_pick_library'))}</button>
      `;
    } else if (isMainLayerList) {
      // Raster/non-vector layer: WMS only, but still offer legend icon choice.
      modeControls = `
        <span class="Qtiler2Origo-mode-switch Qtiler2Origo-mode-switch--static" title="WMS only">WMS</span>
        <button type="button" class="button is-small is-info is-light Qtiler2Origo-mode-switch__config" data-wms-legend-library="${escapeHtml(layerKey)}">${escapeHtml(t('Qtiler2Origo.wms_legend_pick_library'))}</button>
      `;
    }

    // WMS legend controls (thumbnail regen / clear) — the icon picker itself
    // is the unified one opened via the config button above.
    ...
    if (isMainLayerList) {
      wmsLegendControls = `
        <div class="Qtiler2Origo-wms-legend-controls${rule.serveAsWfs ? ' is-invisible' : ''}" title="${escapeHtml(t('Qtiler2Origo.wms_legend_help'))}">
          <button type="button" class="button is-small is-light" data-wms-legend-regen="${escapeHtml(layerKey)}" title="${escapeHtml(t('Qtiler2Origo.wms_legend_regen'))}">↻</button>
          <button type="button" class="button is-small is-light" data-wms-legend-clear="${escapeHtml(layerKey)}" title="${escapeHtml(t('Qtiler2Origo.wms_legend_clear'))}">✕</button>
        </div>
      `;
    }
    ...
    const actionCells = isMainLayerList
      ? `
        <div class="Qtiler2Origo-layer-row__preview">${preview}</div>
        <div class="Qtiler2Origo-layer-row__actions">
          ...
          <div class="Qtiler2Origo-layer-row__mode">${modeControls}${wmsLegendControls}</div>
        </div>
      `
      : modeControls;
...
function syncProjectLayerOptionState() {
  ...
  projectLayersList.querySelectorAll('.Qtiler2Origo-layer-row[data-layer-row]').forEach((row) => {
    ...
    row.querySelectorAll('button[data-wms-legend-pick], button[data-wms-legend-library], button[data-wms-legend-regen], button[data-wms-legend-clear], button[data-layer-mode], select[data-wms-legend-mode], input[data-wms-legend-url], input[data-layer-title]').forEach((el) => {
...
function buildBackgroundOptions() {
  ...
  // Preserve customImageUrl/thumbCacheBust set on existing options (keyed by
  // `key`) since this function rebuilds fresh option objects on every call.
  const preservedByKey = new Map(
    (publishState.backgroundOptions || [])
      .filter((o) => o && o.key && (o.customImageUrl || o.thumbCacheBust))
      .map((o) => [o.key, { customImageUrl: o.customImageUrl, thumbnail: o.thumbnail, thumbCacheBust: o.thumbCacheBust }])
  );
  ...
  for (const opt of options) {
    const preserved = preservedByKey.get(opt.key);
    if (preserved) Object.assign(opt, preserved);
  }
...
function renderDefaultBackgroundOptions() {
  ...
  defaultBackgroundList.innerHTML = publishState.backgroundOptions.map((item) => {
    ...
    const isLayerType = item.type === 'layer' && item.sourceProjectId && item.name;
    let thumbHtml = '';
    if (item.customImageUrl) {
      // Custom uploaded image always takes priority over the autogenerated thumbnail
      thumbHtml = `<img class="Qtiler2Origo-bg-item__thumb" src="${escapeHtml(item.customImageUrl)}" alt="" loading="lazy" />`;
    } else if (isLayerType) {
      const cacheBust = item.thumbCacheBust ? `&_=${encodeURIComponent(item.thumbCacheBust)}` : '';
      const thumbUrl = `/plugins/Qtiler2Origo/api/thumbnail/${encodeURIComponent(item.sourceProjectId)}?LAYERS=${encodeURIComponent(item.name)}${cacheBust}`;
    ...
    const regenBtn = (isLayerType && !item.customImageUrl)
      ? `<button type="button" class="button tiny" data-bg-regen="${escapeHtml(item.key)}" title="${escapeHtml(t('Qtiler2Origo.regen_thumb_title'))}">↻ ${escapeHtml(t('Qtiler2Origo.regen_thumb'))}</button>`
      : '';
    return `
      <label class="Qtiler2Origo-bg-item">
        ...
        ${defaultTag}
        <div class="Qtiler2Origo-bg-item__actions">
          ${item.customImageUrl ? `<span class="badge badge--info">${escapeHtml(t('Qtiler2Origo.custom') || 'Personalizada')}</span>` : ''}
          ${item.customImageUrl ? `<button type="button" class="button tiny" data-bg-clear="${escapeHtml(item.key)}">${escapeHtml(t('Qtiler2Origo.use_autogenerated') || 'Usar autogenerada')}</button>` : `<button type="button" class="button tiny" data-bg-choose="${escapeHtml(item.key)}">${escapeHtml(t('Qtiler2Origo.choose_image') || 'Elegir imagen')}</button>`}
          ${regenBtn}
        </div>
      </label>
    `;
...
defaultBackgroundList?.addEventListener('click', (ev) => {
  const btn = ev.target && ev.target.closest && ev.target.closest('[data-bg-choose], [data-bg-clear], [data-bg-regen]');
  if (!btn) return;
  const chooseKey = btn.getAttribute('data-bg-choose');
  const clearKey = btn.getAttribute('data-bg-clear');
  const regenKey = btn.getAttribute('data-bg-regen');
  if (chooseKey) {
    ev.preventDefault();
  ...
  if (clearKey) {
    ev.preventDefault();
    clearBackgroundCustomImage(clearKey);
    return;
  }
  if (regenKey) {
    ev.preventDefault();
...
async function chooseBackgroundImageForKey(key) {
  const item = (publishState.backgroundOptions || []).find((i) => i && i.key === key);
  if (!item) throw new Error('background_not_found');
  // open asset picker modal (allows choosing existing assets or uploading new)
  const picked = await showAssetPickerModal();
  if (!picked) throw new Error('no_asset_selected');
  item.customImageUrl = picked;
  item.thumbnail = picked;
  refreshBackgroundOptions();
  return picked;
}

async function fetchBackgroundAssets() {
  const payload = await api('/plugins/Qtiler2Origo/api/background-assets', { method: 'GET' });
...
async function uploadBackgroundAsset(file) {
  ...
  const body = new FormData();
  body.append('image', file);
  const payload = await api('/plugins/Qtiler2Origo/api/background-assets/image', { method: 'POST', body });
...
function showAssetPickerModal() {
  return new Promise(async (resolve, reject) => {
    try {
      const assets = await fetchBackgroundAssets().catch(() => []);
      const overlay = document.createElement('div');
      overlay.className = 'Qtiler2Origo-asset-modal overlay';
      const modal = document.createElement('div');
      modal.className = 'Qtiler2Origo-asset-modal__box card';
      modal.innerHTML = `
        <div class="card__head"><strong>${escapeHtml(t('Qtiler2Origo.choose_asset') || 'Choose asset')}</strong></div>
        <div class="card__body Qtiler2Origo-asset-list"></div>
        <div class="card__foot" style="text-align:right">
          <button type="button" class="button" data-asset-cancel>${escapeHtml(t('Qtiler2Origo.cancel') || 'Cancel')}</button>
        </div>
      `;
      overlay.appendChild(modal);
      document.body.appendChild(overlay);

      const listEl = modal.querySelector('.Qtiler2Origo-asset-list');
      const renderList = (items) => {
        if (!items || !items.length) {
          const setupLabel = escapeHtml(t('Qtiler2Origo.tab_setup') || 'Setup');
          const msg = escapeHtml(t('Qtiler2Origo.no_assets') || 'No uploaded images. Please go to Setup and upload some images first.');
          listEl.innerHTML = `
            <div style="padding:1rem">
              <div style="margin-bottom:.5rem">${msg}</div>
              <div><button type="button" class="button" data-asset-open-setup>${setupLabel}</button></div>
            </div>
          `;
          const btn = listEl.querySelector('[data-asset-open-setup]');
          if (btn) btn.addEventListener('click', () => {
            // Open the Setup tab in the main UI
        ...
        listEl.innerHTML = items.map((it) => `
          <label class="Qtiler2Origo-asset-item" data-asset-url="${escapeHtml(it.url)}">
            <img src="${escapeHtml(it.url)}" alt="${escapeHtml(it.fileName)}" style="max-width:120px;max-height:80px;display:block;margin-bottom:4px" />
            <div class="Qtiler2Origo-asset-item__name">${escapeHtml(it.fileName)}</div>
          </label>
        `).join('');
      };
      ...
      uploadBtn.style.margin = '0 0 8px 8px';
      uploadBtn.textContent = t('Qtiler2Origo.upload_new') || 'Upload new...';
      uploadBtn.addEventListener('click', () => {
        ...
        input.addEventListener('change', async () => {
          ...
          try {
            ...
            // re-fetch assets list and select the uploaded one
            const updated = await fetchBackgroundAssets().catch(() => []);
            renderList(updated);
      ...
      modal.querySelector('.card__head').appendChild(uploadBtn);

      renderList(assets);

      const clickHandler = (ev) => {
        const node = ev.target.closest && ev.target.closest('.Qtiler2Origo-asset-item');
        if (!node) return;
        const url = node.getAttribute('data-asset-url');
        if (url) {
          resolve(url);
          cleanup();
        }
      ...
      const cancelBtn = modal.querySelector('[data-asset-cancel]');
      cancelBtn.addEventListener('click', () => { resolve(null); cleanup(); });
      overlay.addEventListener('click', (ev) => { if (ev.target === overlay) { resolve(null); cleanup(); } });
...
function clearBackgroundCustomImage(key) {
  const item = (publishState.backgroundOptions || []).find((i) => i && i.key === key);
  if (!item) return;
  delete item.customImageUrl;
  // restore thumbnail if it was derived from layer
  if (item.type === 'layer' && item.sourceProjectId && item.name) {
    item.thumbnail = `/plugins/Qtiler2Origo/api/thumbnail/${encodeURIComponent(item.sourceProjectId)}?LAYERS=${encodeURIComponent(item.name)}`;
  } else {
...
function closePublishModal({ force = false } = {}) {
  if (!force && publishEditorDirty) {
    if (!window.confirm(t('Qtiler2Origo.unsaved_changes_confirm'))) return;
  }
...
async function preparePublishModal(editProfileId = null) {
  ...
  if (editProfileId) {
    ...
    if (profile) {
      ...
      // Default background
      refreshBackgroundOptions();
      // Restore any custom (uploaded) background image saved on the profile.
      // Autogenerated thumbnails are served from our own API and must not be
      // treated as "custom"; only external/uploaded asset URLs qualify.
      profileBackgrounds.forEach((bg) => {
        const bgKey = String(bg?.key || '').trim();
        const bgImageUrl = String(bg?.imageUrl || '').trim();
        if (!bgKey || !bgImageUrl || bgImageUrl.startsWith('/plugins/Qtiler2Origo/api/thumbnail/')) return;
        const opt = (publishState.backgroundOptions || []).find((o) => o && o.key === bgKey);
        if (opt) opt.customImageUrl = bgImageUrl;
      });
      renderDefaultBackgroundOptions();
  ...
  // Runs after the modal opens so restored values render immediately.
...
legendLibraryGrid?.addEventListener('click', async (event) => {
  ...
  let usageText = '';
  try {
    const usagePayload = await api(`/plugins/Qtiler2Origo/api/legend-library/${encodeURIComponent(id)}/usage`);
  ...
  // Also check the current (possibly unpublished) draft state.
  ...
  if (itemUrl) {
    ...
    if (localLayers.length) {
      usageText += (usageText ? ' · ' : '') + `${t('Qtiler2Origo.legend_current_map')}: ${localLayers.slice(0, 4).join(', ')}${localLayers.length > 4 ? '…' : ''}`;
    }
  }

  const confirmMsg = usageText
    ? t('Qtiler2Origo.legend_delete_in_use', { n: usageText.split(';').length, layers: usageText })
    : t('Qtiler2Origo.legend_delete_confirm');
...
projectLayersList?.addEventListener('click', (event) => {
  const target = event.target;
  if (!(target instanceof Element)) return;
  // New segmented WMS/WFS mode switch
  ...
  // same entry point for both modes so the UX is identical.
  ...
  openLegendLibraryPicker((url) => {
    ...
    publishState.mainRules[layerName].wmsLegendMode = 'library';
...
// ── Server-side drafts ─────────────────────────────────────────────────────
// Drafts live on the server (data/Qtiler2Origo/origo/drafts/) so they survive
// browser restarts and are shared across machines.
...
async function saveDraftToServer() {
  ...
  await api(`/plugins/Qtiler2Origo/api/drafts/${encodeURIComponent(draftId)}`, {
    method: 'PUT',
...
async function fetchDraftFromServer(draftId) {
  try {
    return await api(`/plugins/Qtiler2Origo/api/drafts/${encodeURIComponent(draftId)}`);
  } catch {
    return null;
  }
}
...
async function deleteDraftFromServer(draftId) {
  try { await api(`/plugins/Qtiler2Origo/api/drafts/${encodeURIComponent(draftId)}`, { method: 'DELETE' }); } catch {}
}

// Ask the user whether to restore a server-side draft when opening the editor.
// Returns true if a draft was offered (user answered); false if none exists.
async function maybeRestoreDraft(editProfileId) {
  ...
  const restore = window.confirm(t('Qtiler2Origo.draft_restore_msg', { date: when }));
  if (!restore) {
  ...
  try {
    ...
    addLog(t('Qtiler2Origo.draft_restored'), 'ok');
  } catch (err) {
    addLog(t('Qtiler2Origo.log_error', { msg: err.message }), 'error');
  }
  return true;
...
// Apply a saved draft body onto the editor state. The draft body matches the
// publish payload shape, so we re-map the fields the editor tracks.
function applyDraftPayload(draft) {
  ...
  if (Array.isArray(draft.backgrounds)) {
    // Restore custom image choices onto the freshly built background options
    for (const bg of draft.backgrounds) {
      const opt = (publishState.backgroundOptions || []).find((o) => o && o.key === bg?.key);
      if (opt && bg?.imageUrl && !String(bg.imageUrl).startsWith('/plugins/Qtiler2Origo/api/thumbnail/')) {
...
saveDraftBtn?.addEventListener('click', async () => {
  ...
  try {
    ...
    addLog(t('Qtiler2Origo.draft_save_failed', { msg: err?.message || err }), 'error');
  } finally {
    setTimeout(() => {
...
preflightPublishBtn?.addEventListener('click', async () => {
  ...
  try {
    const { body } = buildPublishApiBody();
    const result = await api('/plugins/Qtiler2Origo/api/publish', { method: 'POST', body: { ...body, dryRun: true } });
    ...
    if (!checks.length) {
      ...
      if (result?.ok) addLog(t('Qtiler2Origo.preflight_ok'), 'ok');
    }
  } catch (err) {
    if (err?.field === 'name') {
...
function openLegendLibraryPicker(targetCallback) {
  let modal = document.getElementById('Qtiler2OrigoLegendPicker');
  if (!modal) {
    modal = document.createElement('div');
    modal.id = 'Qtiler2OrigoLegendPicker';
    modal.className = 'modal';
    modal.innerHTML = `
      <div class="modal-background" data-close-legend-picker></div>
      <div class="modal-card Qtiler2Origo-legend-picker__card">
        <header class="modal-card-head">
          <p class="modal-card-title">${escapeHtml(t('Qtiler2Origo.legend_pick_title'))}</p>
          <button type="button" class="delete" aria-label="close" data-close-legend-picker></button>
        </header>
        <section class="modal-card-body">
          <div class="Qtiler2Origo-legend-picker__toolbar">
            <div class="Qtiler2Origo-legend-picker__tabs">
              <button type="button" class="button is-small" data-legend-tab="library">${escapeHtml(t('Qtiler2Origo.legend_pick_uploaded'))}</button>
              <button type="button" class="button is-small" data-legend-tab="qgis">${escapeHtml(t('Qtiler2Origo.legend_pick_qgis_svg'))}</button>
            </div>
            <input class="input is-small Qtiler2Origo-legend-picker__search" type="search" placeholder="${escapeHtml(t('Qtiler2Origo.legend_search_placeholder'))}" />
            <button type="button" class="button is-small is-primary" data-legend-upload>${escapeHtml(t('Qtiler2Origo.legend_upload_new'))}</button>
          </div>
          <div class="Qtiler2Origo-legend-picker__grid" data-legend-grid></div>
        </section>
      </div>`;
    document.body.appendChild(modal);
    ...
    const renderGrid = () => {
      ...
      if (st.tab === 'library') {
        ...
        grid.innerHTML = items.map((item) => `
          <button type="button" class="Qtiler2Origo-legend-pick" data-legend-pick="${escapeHtml(item.url)}" title="${escapeHtml(item.name || '')}">
            <img src="${escapeHtml(item.url)}" alt="" />
      ...
      if (!icons.length) {
        grid.innerHTML = `<p class="help">${escapeHtml(t('Qtiler2Origo.no_assets'))}</p>`;
        return;
      }
      grid.innerHTML = icons.map((ic) => `
        <button type="button" class="Qtiler2Origo-legend-pick" data-legend-pick="${escapeHtml(ic.url)}" title="${escapeHtml(ic.label)}">
...
async function applyMapJsonChanges({ automatic = false } = {}) {
  try {
    ...
    for (const layer of configuredLayers) {
      ...
      if (layer.title) nextRule.title = String(layer.title).trim();
    ...
    publishState.layerOrder = Array.isArray(config.layerOrder) && config.layerOrder.length
      ? config.layerOrder.map((key) => String(key || '').trim()).filter(Boolean)
      : includedKeys.slice();
    ensureLayerOrderKeys(includedKeys);
    ...
    if (backgroundProjectId) {
      ...
      if (backgroundLayersList) backgroundLayersList.innerHTML = `<p class="help">${escapeHtml(t('Qtiler2Origo.optional_select'))}</p>`;
      refreshBackgroundOptions();
    }
