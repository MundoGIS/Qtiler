...
const LantmateriSearch = function LantmateriSearch(options = {}) {
  ...
  function createButton() {
    ...
    buttonEl.innerHTML = '<span class="icon"><img src="/css/images/Qtiler2OrigoLMV.svg" alt="LMV" style="width:100%;height:100%;display:block;pointer-events:none;" /></span>';
...
console.log('[Qtiler2Origo] LantmateriSearch control loaded and registered to window');
