...
QTWC_I18N.no = Object.assign({}, QTWC_I18N.sv, {
  'Qtiler2qwc.title': 'QWC2-bro for Qtiler',
  'Qtiler2qwc.subtitle': 'Installer QWC2 fra GitHub og synkroniser prosjektsynlighet fra QtilerAuth.',
  'Qtiler2qwc.installation': 'Installasjon',
  'Qtiler2qwc.github_repo': 'GitHub-repo',
  'Qtiler2qwc.version_tag': 'Versjon',
  'Qtiler2qwc.include_prerelease': 'Ta med forhåndsutgivelser',
  'Qtiler2qwc.no_releases_found': '(ingen utgivelser funnet)',
  'Qtiler2qwc.releases_error': '(feil ved henting av utgivelser)',
  'Qtiler2qwc.install_qwc2': 'Installer QWC2',
  'Qtiler2qwc.uninstall_qwc2': 'Avinstaller QWC2',
  'Qtiler2qwc.checking': 'Kontrollerer…',
  'Qtiler2qwc.installed': 'Installert',
  'Qtiler2qwc.not_installed': 'Ikke installert',
  'Qtiler2qwc.installed_at': 'Installert {date} · repo {repo} · versjon {version}',
  'Qtiler2qwc.not_installed_hint': 'QWC2 er ikke installert. Angi repo og versjon over, og klikk Installer.',
  'Qtiler2qwc.standalone_server': 'Frittstående QWC2-server',
  'Qtiler2qwc.qwc2_port': 'QWC2-port',
  'Qtiler2qwc.start_server': 'Start server',
  'Qtiler2qwc.stop_server': 'Stopp server',
  'Qtiler2qwc.open_qwc2': 'Åpne QWC2',
  'Qtiler2qwc.webmap_link': 'Åpne webkart',
  'Qtiler2qwc.running': 'Kjører',
  'Qtiler2qwc.stopped': 'Stoppet',
  'Qtiler2qwc.server_running_at': 'Server kjører på port {port}',
  'Qtiler2qwc.server_stopped_hint': 'Serveren kjører ikke. Angi port og klikk Start.',
  'Qtiler2qwc.logo_section': 'Webkart-logo',
  'Qtiler2qwc.logo_desc': 'Last opp en logo for QWC2 TopBar. Tillatte formater: PNG, JPG, SVG, WEBP.',
  'Qtiler2qwc.logo_file': 'Logofil',
  'Qtiler2qwc.upload_logo': 'Last opp logo',
  'Qtiler2qwc.remove_logo': 'Fjern logo',
  'Qtiler2qwc.no_logo': 'Ingen logo',
  'Qtiler2qwc.logo_active': 'Aktiv',
  'Qtiler2qwc.profiles_section': 'Publiserte profiler',
  'Qtiler2qwc.profiles_desc': 'Administrer genererte profiler og startlenker for QWC2 (webkart).',
  'Qtiler2qwc.publish_new': 'Ny profil',
  'Qtiler2qwc.open_qwc2_link': 'Åpne kart',
  'Qtiler2qwc.edit_profile': 'Rediger',
  'Qtiler2qwc.delete': 'Slett',
  'Qtiler2qwc.open_viewer': 'Åpne QWC2-viser',
  'Qtiler2qwc.activity_log': 'Aktivitetslogg',
  'Qtiler2qwc.clear': 'Tøm',
  'Qtiler2qwc.no_activity': 'Ingen aktivitet ennå.',
  'Qtiler2qwc.modal_title': 'Publiser prosjekt i QWC2',
  'Qtiler2qwc.main_project': 'Hovedprosjekt',
  'Qtiler2qwc.project_layers': 'Prosjektlag',
  'Qtiler2qwc.bg_project': 'Bakgrunnsprosjekt (valgfritt)',
  'Qtiler2qwc.bg_layers': 'Bakgrunnslag',
  'Qtiler2qwc.default_bg': 'Standard bakgrunn',
  'Qtiler2qwc.default_bg_help': 'OSM og Ingen bakgrunn er alltid tilgjengelige. Velg én som standard.',
  'Qtiler2qwc.publish_now': 'Publiser',
  'Qtiler2qwc.cancel': 'Avbryt',
  'Qtiler2qwc.loading': 'Laster...',
  'Qtiler2qwc.tab_setup': 'Oppsett',
  'Qtiler2qwc.tab_maps': 'Kart',
  'Qtiler2qwc.tab_log': 'Logg',
  'Qtiler2qwc.map_name': 'Kartnavn',
  'Qtiler2qwc.map_description': 'Beskrivelse',
  'Qtiler2qwc.step_layers': '1. Lag',
  'Qtiler2qwc.step_backgrounds': '2. Bakgrunnskart',
  'Qtiler2qwc.step_tools': '3. Verktøy',
  'Qtiler2qwc.hiw.button': 'Slik fungerer det og sikkerhet',
  'Qtiler2qwc.hiw.title': 'Slik fungerer QTWC og hvorfor det er sikkert',
  'Qtiler2qwc.hiw.lead': 'QTWC bygger inn QWC2-webkartviseren i Qtiler. Den laster ned QWC2 fra en låst GitHub-release, genererer temakatalogen fra QGIS-prosjektene dine og lar QtilerAuth håndheve synlighet per bruker.',
  'Qtiler2qwc.hiw.arch.title': '1. Arkitektur',
  'Qtiler2qwc.hiw.flow.title': '2. Steg for steg',
  'Qtiler2qwc.hiw.themes.title': '3. Temaer og prosjekter',
  'Qtiler2qwc.hiw.print.title': '4. Utskrift (serverless-kontrakt)',
  'Qtiler2qwc.hiw.auth.title': '5. Autentisering og synlighet',
  'Qtiler2qwc.hiw.security.title': '6. Sikkerhet og personvern',
  'Qtiler2qwc.catalog_texts_section': 'Tekster for katalogsiden',
  'Qtiler2qwc.catalog_texts_desc': 'Tilpass overskriften og beskrivelsen som vises på /Qtiler2qwc/webmap/. La felt stå tomme for å bruke standardtekst.',
  'Qtiler2qwc.catalog_title_label': 'Sidetittel',
  'Qtiler2qwc.catalog_desc_public_label': 'Beskrivelse for offentlige / ikke-innloggede besøkende',
  'Qtiler2qwc.catalog_desc_auth_label': 'Beskrivelse for innloggede brukere (la stå tomt for å bruke offentlig tekst)',
  'Qtiler2qwc.catalog_texts_save': 'Lagre',
  'Qtiler2qwc.catalog_texts_saved': 'Lagret.'
});
QTWC_I18N.nb = QTWC_I18N.no;
QTWC_I18N.nn = QTWC_I18N.no;
QTWC_I18N.da = Object.assign({}, QTWC_I18N.sv, {
  'Qtiler2qwc.title': 'QWC2-bro til Qtiler',
  'Qtiler2qwc.subtitle': 'Installer QWC2 fra GitHub, og synkroniser projektsynlighed fra QtilerAuth.',
  'Qtiler2qwc.installation': 'Installation',
  'Qtiler2qwc.github_repo': 'GitHub-repo',
  'Qtiler2qwc.version_tag': 'Version',
  'Qtiler2qwc.include_prerelease': 'Medtag pre-releases',
  'Qtiler2qwc.no_releases_found': '(ingen releases fundet)',
  'Qtiler2qwc.releases_error': '(fejl ved hentning af releases)',
  'Qtiler2qwc.install_qwc2': 'Installer QWC2',
  'Qtiler2qwc.uninstall_qwc2': 'Afinstaller QWC2',
  'Qtiler2qwc.checking': 'Kontrollerer…',
  'Qtiler2qwc.installed': 'Installeret',
  'Qtiler2qwc.not_installed': 'Ikke installeret',
  'Qtiler2qwc.not_installed_hint': 'QWC2 er ikke installeret. Angiv repo og version ovenfor, og klik Installer.',
  'Qtiler2qwc.start_server': 'Start server',
  'Qtiler2qwc.stop_server': 'Stop server',
  'Qtiler2qwc.open_qwc2': 'Åbn QWC2',
  'Qtiler2qwc.webmap_link': 'Åbn webkort',
  'Qtiler2qwc.running': 'Kører',
  'Qtiler2qwc.stopped': 'Stoppet',
  'Qtiler2qwc.logo_section': 'Webkort-logo',
  'Qtiler2qwc.logo_desc': 'Upload et logo til QWC2 TopBar. Tilladte formater: PNG, JPG, SVG, WEBP.',
  'Qtiler2qwc.logo_file': 'Logofil',
  'Qtiler2qwc.upload_logo': 'Upload logo',
  'Qtiler2qwc.remove_logo': 'Fjern logo',
  'Qtiler2qwc.no_logo': 'Intet logo',
  'Qtiler2qwc.profiles_section': 'Publicerede profiler',
  'Qtiler2qwc.profiles_desc': 'Administrer genererede profiler og startlinks til QWC2 (webkort).',
  'Qtiler2qwc.publish_new': 'Ny profil',
  'Qtiler2qwc.open_qwc2_link': 'Åbn kort',
  'Qtiler2qwc.edit_profile': 'Rediger',
  'Qtiler2qwc.delete': 'Slet',
  'Qtiler2qwc.open_viewer': 'Åbn QWC2-viser',
  'Qtiler2qwc.activity_log': 'Aktivitetslog',
  'Qtiler2qwc.clear': 'Ryd',
  'Qtiler2qwc.no_activity': 'Ingen aktivitet endnu.',
  'Qtiler2qwc.modal_title': 'Publicér projekt i QWC2',
  'Qtiler2qwc.main_project': 'Hovedprojekt',
  'Qtiler2qwc.project_layers': 'Projektlag',
  'Qtiler2qwc.bg_project': 'Baggrundsprojekt (valgfrit)',
  'Qtiler2qwc.bg_layers': 'Baggrundslag',
  'Qtiler2qwc.default_bg': 'Standardbaggrund',
  'Qtiler2qwc.default_bg_help': 'OSM og Ingen baggrund er altid tilgængelige. Vælg én som standard.',
  'Qtiler2qwc.publish_now': 'Publicér',
  'Qtiler2qwc.cancel': 'Annuller',
  'Qtiler2qwc.loading': 'Indlæser...',
  'Qtiler2qwc.tab_setup': 'Opsætning',
  'Qtiler2qwc.tab_maps': 'Kort',
  'Qtiler2qwc.tab_log': 'Log',
  'Qtiler2qwc.map_name': 'Kortnavn',
  'Qtiler2qwc.map_description': 'Beskrivelse',
  'Qtiler2qwc.step_layers': '1. Lag',
  'Qtiler2qwc.step_backgrounds': '2. Baggrundskort',
  'Qtiler2qwc.step_tools': '3. Værktøjer',
  'Qtiler2qwc.hiw.button': 'Sådan fungerer det og sikkerhed',
  'Qtiler2qwc.hiw.title': 'Sådan fungerer QTWC, og hvorfor det er sikkert',
  'Qtiler2qwc.hiw.lead': 'QTWC indlejrer QWC2-webkortviseren i Qtiler. Den henter QWC2 fra en fast GitHub-release, genererer temakataloget fra dine QGIS-projekter og lader QtilerAuth håndhæve synlighed pr. bruger.',
  'Qtiler2qwc.hiw.arch.title': '1. Arkitektur',
  'Qtiler2qwc.hiw.flow.title': '2. Trin for trin',
  'Qtiler2qwc.hiw.themes.title': '3. Temaer og projekter',
  'Qtiler2qwc.hiw.print.title': '4. Udskrift (serverless-kontrakt)',
  'Qtiler2qwc.hiw.auth.title': '5. Autentificering og synlighed',
  'Qtiler2qwc.hiw.security.title': '6. Sikkerhed og privatliv',
  'Qtiler2qwc.catalog_texts_section': 'Tekster til katalogsiden',
  'Qtiler2qwc.catalog_texts_desc': 'Tilpas overskriften og beskrivelsen, der vises på /Qtiler2qwc/webmap/. Lad et felt være tomt for at bruge standardteksten.',
  'Qtiler2qwc.catalog_title_label': 'Sidetitel',
  'Qtiler2qwc.catalog_desc_public_label': 'Beskrivelse for offentlige / ikke-loggede besøgende',
  'Qtiler2qwc.catalog_desc_auth_label': 'Beskrivelse for loggede brugere (lad stå tomt for at genbruge den offentlige tekst)',
  'Qtiler2qwc.catalog_texts_save': 'Gem',
  'Qtiler2qwc.catalog_texts_saved': 'Gemt.',
  'Qtiler2qwc.login': 'Log ind'
});
QTWC_I18N.fi = Object.assign({}, QTWC_I18N.en, {
  'Qtiler2qwc.title': 'QWC2-silta Qtilerille',
  'Qtiler2qwc.subtitle': 'Asenna QWC2 GitHubista ja synkronoi projektien näkyvyys QtilerAuthista.',
  'Qtiler2qwc.installation': 'Asennus',
  'Qtiler2qwc.github_repo': 'GitHub-repositorio',
  'Qtiler2qwc.version_tag': 'Versio',
  'Qtiler2qwc.include_prerelease': 'Sisällytä esijulkaisut',
  'Qtiler2qwc.no_releases_found': '(julkaisuja ei löytynyt)',
  'Qtiler2qwc.releases_error': '(julkaisujen haku epäonnistui)',
  'Qtiler2qwc.install_qwc2': 'Asenna QWC2',
  'Qtiler2qwc.uninstall_qwc2': 'Poista QWC2',
  'Qtiler2qwc.checking': 'Tarkistetaan…',
  'Qtiler2qwc.installed': 'Asennettu',
  'Qtiler2qwc.not_installed': 'Ei asennettu',
  'Qtiler2qwc.installed_at': 'Asennettu {date} · repo {repo} · versio {version}',
  'Qtiler2qwc.not_installed_hint': 'QWC2 ei ole asennettu. Anna repo ja versio yllä ja napsauta Asenna.',
  'Qtiler2qwc.standalone_server': 'Erillinen QWC2-palvelin',
  'Qtiler2qwc.qwc2_port': 'QWC2-portti',
  'Qtiler2qwc.start_server': 'Käynnistä palvelin',
  'Qtiler2qwc.stop_server': 'Pysäytä palvelin',
  'Qtiler2qwc.open_qwc2': 'Avaa QWC2',
  'Qtiler2qwc.webmap_link': 'Avaa verkkokartta',
  'Qtiler2qwc.running': 'Käynnissä',
  'Qtiler2qwc.stopped': 'Pysäytetty',
  'Qtiler2qwc.server_running_at': 'Palvelin käynnissä portissa {port}',
  'Qtiler2qwc.server_stopped_hint': 'Palvelin ei ole käynnissä. Aseta portti ja napsauta Käynnistä.',
  'Qtiler2qwc.logo_section': 'Verkkokartan logo',
  'Qtiler2qwc.logo_desc': 'Lataa logo QWC2 TopBariin. Sallitut muodot: PNG, JPG, SVG, WEBP.',
  'Qtiler2qwc.logo_file': 'Logotiedosto',
  'Qtiler2qwc.upload_logo': 'Lataa logo',
  'Qtiler2qwc.remove_logo': 'Poista logo',
  'Qtiler2qwc.no_logo': 'Ei logoa',
  'Qtiler2qwc.logo_active': 'Aktiivinen',
  'Qtiler2qwc.profiles_section': 'Julkaistut profiilit',
  'Qtiler2qwc.profiles_desc': 'Hallitse QWC2:n (verkkokartan) luotuja profiileja ja avauslinkkejä.',
  'Qtiler2qwc.publish_new': 'Uusi profiili',
  'Qtiler2qwc.open_qwc2_link': 'Avaa kartta',
  'Qtiler2qwc.edit_profile': 'Muokkaa',
  'Qtiler2qwc.delete': 'Poista',
  'Qtiler2qwc.open_viewer': 'Avaa QWC2-katselin',
  'Qtiler2qwc.activity_log': 'Toimintaloki',
  'Qtiler2qwc.clear': 'Tyhjennä',
  'Qtiler2qwc.no_activity': 'Ei vielä toimintaa.',
  'Qtiler2qwc.modal_title': 'Julkaise projekti QWC2:ssa',
  'Qtiler2qwc.main_project': 'Pääprojekti',
  'Qtiler2qwc.project_layers': 'Projektin tasot',
  'Qtiler2qwc.bg_project': 'Taustaprojekti (valinnainen)',
  'Qtiler2qwc.bg_layers': 'Taustatasot',
  'Qtiler2qwc.default_bg': 'Oletustausta',
  'Qtiler2qwc.default_bg_help': 'OSM ja Ei taustaa ovat aina käytettävissä. Valitse yksi oletukseksi.',
  'Qtiler2qwc.publish_now': 'Julkaise',
  'Qtiler2qwc.cancel': 'Peruuta',
  'Qtiler2qwc.loading': 'Ladataan...',
  'Qtiler2qwc.tab_setup': 'Asetukset',
  'Qtiler2qwc.tab_maps': 'Kartat',
  'Qtiler2qwc.tab_log': 'Loki',
  'Qtiler2qwc.map_name': 'Kartan nimi',
  'Qtiler2qwc.map_description': 'Kuvaus',
  'Qtiler2qwc.step_layers': '1. Tasot',
  'Qtiler2qwc.step_backgrounds': '2. Taustakartat',
  'Qtiler2qwc.step_tools': '3. Työkalut',
  'Qtiler2qwc.hiw.button': 'Miten se toimii ja turvallisuus',
  'Qtiler2qwc.hiw.title': 'Miten QTWC toimii ja miksi se on turvallinen',
  'Qtiler2qwc.hiw.lead': 'QTWC upottaa QWC2-verkkokarttakatselimen Qtileriin. Se lataa QWC2:n kiinnitetystä GitHub-julkaisusta, luo teemakatalogin QGIS-projekteistasi ja antaa QtilerAuthin hallita käyttäjäkohtaista näkyvyyttä.',
  'Qtiler2qwc.hiw.arch.title': '1. Arkkitehtuuri',
  'Qtiler2qwc.hiw.flow.title': '2. Vaihe vaiheelta',
  'Qtiler2qwc.hiw.themes.title': '3. Teemat ja projektit',
  'Qtiler2qwc.hiw.print.title': '4. Tulostus (palvelimeton sopimus)',
  'Qtiler2qwc.hiw.auth.title': '5. Todennus ja näkyvyys',
  'Qtiler2qwc.hiw.security.title': '6. Turvallisuus ja yksityisyys',
  'Qtiler2qwc.catalog_texts_section': 'Katalogisivun tekstit',
  'Qtiler2qwc.catalog_texts_desc': 'Mukauta /Qtiler2qwc/webmap/-sivulla näkyvää otsikkoa ja kuvausta. Jätä kenttä tyhjäksi käyttääksesi oletustekstiä.',
  'Qtiler2qwc.catalog_title_label': 'Sivun otsikko',
  'Qtiler2qwc.catalog_desc_public_label': 'Kuvaus julkisille / kirjautumattomille kävijöille',
  'Qtiler2qwc.catalog_desc_auth_label': 'Kuvaus kirjautuneille käyttäjille (jätä tyhjäksi käyttääksesi julkista tekstiä)',
  'Qtiler2qwc.catalog_texts_save': 'Tallenna',
  'Qtiler2qwc.catalog_texts_saved': 'Tallennettu.',
  'Qtiler2qwc.login': 'Kirjaudu sisään'
});
