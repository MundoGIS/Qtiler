...
const QTWC_I18N = {
  en: {
    ...
    'Qtiler2Hajk.subtitle': 'Install Hajk from GitHub, publish maps visually, and power a public portal with or without QtilerAuth.',
    'Qtiler2Hajk.how_title': 'How Qtiler2Hajk works',
    'Qtiler2Hajk.how_intro': 'Qtiler2Hajk is the base bridge between Qtiler and Hajk: it publishes QGIS-backed web maps and now also drives a visual portal/CMS for the public /Qtiler2Hajk/maps site without leaving the admin console.',
    ...
    'Qtiler2Hajk.how_step_share': 'Share maps and pages — published viewers are reachable directly and the portal home lives at /Qtiler2Hajk/maps, where admins can present selected maps as thumbnails, embeds or open-link cards.',
    'Qtiler2Hajk.how_step_brand': 'Brand and customise — upload a logo, configure toolbar controls, and design portal pages with header options, cards, rich text and map sections. Changes hot-reload without restarting Qtiler.',
    ...
    'Qtiler2Hajk.tab_portal': 'Portal',
    'Qtiler2Hajk.tab_log': 'Log',
    'Qtiler2Hajk.portal_section': 'Portal pages',
    'Qtiler2Hajk.portal_desc': 'Create editorial landing pages for the public maps portal, with sections, featured maps and audience rules.',
    'Qtiler2Hajk.portal_add_page': 'New page',
    'Qtiler2Hajk.portal_duplicate_page': 'Duplicate page',
    'Qtiler2Hajk.portal_save': 'Save portal',
    'Qtiler2Hajk.portal_open_page': 'Open page',
    'Qtiler2Hajk.portal_templates': 'Templates',
    'Qtiler2Hajk.portal_templates_help': 'Start from a polished layout and then adapt text, maps and news blocks.',
    'Qtiler2Hajk.portal_apply_template': 'Apply template',
    'Qtiler2Hajk.portal_pages_list': 'Pages',
    'Qtiler2Hajk.portal_empty': 'Create the first page to turn the maps portal into an editorial landing page.',
    'Qtiler2Hajk.portal_page_title': 'Page title',
    'Qtiler2Hajk.portal_page_slug': 'Slug',
    'Qtiler2Hajk.portal_page_nav': 'Navigation label',
    'Qtiler2Hajk.portal_page_summary': 'Short summary',
    'Qtiler2Hajk.portal_site_header_height': 'Header height',
    'Qtiler2Hajk.portal_site_header_font': 'Header font',
    'Qtiler2Hajk.portal_site_header_color1': 'Header color 1',
    'Qtiler2Hajk.portal_site_header_color2': 'Header color 2',
    'Qtiler2Hajk.portal_site_header_text_color': 'Header text color',
    'Qtiler2Hajk.portal_site_header_background_url': 'Header background image URL',
    'Qtiler2Hajk.portal_site_footer_text': 'Footer text',
    'Qtiler2Hajk.portal_site_footer_link_label': 'Footer link label',
    'Qtiler2Hajk.portal_site_footer_link_url': 'Footer link URL',
    'Qtiler2Hajk.portal_site_footer_background_color': 'Footer background color',
    'Qtiler2Hajk.portal_site_footer_text_color': 'Footer text color',
    'Qtiler2Hajk.portal_site_footer_link_color': 'Footer link color',
    'Qtiler2Hajk.portal_header_logo': 'Header logo URL',
    'Qtiler2Hajk.portal_header_height': 'Header height',
    'Qtiler2Hajk.portal_show_header': 'Show header',
    'Qtiler2Hajk.portal_visibility': 'Page visibility',
    'Qtiler2Hajk.portal_vis_public': 'Public',
    'Qtiler2Hajk.portal_vis_authenticated': 'Authenticated users',
    'Qtiler2Hajk.portal_vis_restricted': 'Specific users / roles',
    'Qtiler2Hajk.portal_users': 'Allowed users',
    'Qtiler2Hajk.portal_roles': 'Allowed roles',
    'Qtiler2Hajk.portal_users_catalog': 'Users list',
    'Qtiler2Hajk.portal_roles_catalog': 'Roles list',
    'Qtiler2Hajk.portal_show_in_nav': 'Show in navigation',
    'Qtiler2Hajk.portal_set_home': 'Use as portal home',
    'Qtiler2Hajk.portal_blocks': 'Sections',
    'Qtiler2Hajk.portal_blocks_help': 'Combine hero, text, card, social and map sections to build a polished landing page.',
    'Qtiler2Hajk.portal_add_block': 'Add section',
    'Qtiler2Hajk.portal_preview': 'Live preview',
    'Qtiler2Hajk.portal_preview_note': 'Desktop preview',
    'Qtiler2Hajk.portal_fullscreen': 'Fullscreen editor',
    'Qtiler2Hajk.portal_device_desktop': 'Desktop',
    'Qtiler2Hajk.portal_device_tablet': 'Tablet',
    'Qtiler2Hajk.portal_device_mobile': 'Mobile',
    'Qtiler2Hajk.portal_block_hero': 'Hero',
    'Qtiler2Hajk.portal_block_text': 'Text',
    'Qtiler2Hajk.portal_block_cards': 'Cards / news',
    'Qtiler2Hajk.portal_block_maps': 'Featured maps',
    'Qtiler2Hajk.portal_block_social': 'Social links',
    'Qtiler2Hajk.portal_block_visibility': 'Section visibility',
    'Qtiler2Hajk.portal_vis_inherit': 'Same as page',
    'Qtiler2Hajk.portal_intro': 'Intro text',
    'Qtiler2Hajk.portal_body': 'Body text',
    'Qtiler2Hajk.portal_eyebrow': 'Eyebrow',
    'Qtiler2Hajk.portal_background_url': 'Background image URL',
    'Qtiler2Hajk.portal_cta_label': 'Button label',
    'Qtiler2Hajk.portal_cta_url': 'Button URL',
    'Qtiler2Hajk.portal_layout': 'Layout',
    'Qtiler2Hajk.portal_layout_grid': 'Grid',
    'Qtiler2Hajk.portal_layout_featured': 'Featured',
    'Qtiler2Hajk.portal_map_display': 'Map display',
    'Qtiler2Hajk.portal_map_display_thumbnail': 'Thumbnail cards',
    'Qtiler2Hajk.portal_map_display_embed': 'Integrated map',
    'Qtiler2Hajk.portal_map_display_open': 'Open map link',
    'Qtiler2Hajk.portal_map_profiles': 'Map profiles',
    'Qtiler2Hajk.portal_maps_catalog': 'Published maps',
    'Qtiler2Hajk.portal_add_item': 'Add item',
    'Qtiler2Hajk.portal_item_title': 'Item title',
    'Qtiler2Hajk.portal_item_text': 'Item text',
    'Qtiler2Hajk.portal_item_url': 'Link URL',
    'Qtiler2Hajk.portal_item_label': 'Link label',
    'Qtiler2Hajk.portal_item_icon': 'Icon',
    'Qtiler2Hajk.portal_item_meta': 'Meta / date',
    'Qtiler2Hajk.portal_item_image': 'Image URL',
    'Qtiler2Hajk.portal_move_up': 'Up',
    'Qtiler2Hajk.portal_move_down': 'Down',
    'Qtiler2Hajk.portal_edit_page': 'Edit page',
    'Qtiler2Hajk.portal_delete': 'Delete',
    'Qtiler2Hajk.portal_home_badge': 'Home',
    'Qtiler2Hajk.portal_hidden_badge': 'Hidden from nav',
    'Qtiler2Hajk.portal_saved': 'Portal pages saved.',
    'Qtiler2Hajk.portal_backup_title': 'Export / import portal backup',
    'Qtiler2Hajk.portal_backup_pages': 'Portal pages to export',
    'Qtiler2Hajk.portal_backup_maps': 'Published maps to export',
    'Qtiler2Hajk.portal_backup_export': 'Export JSON',
    'Qtiler2Hajk.portal_backup_import': 'Import / restore JSON',
    'Qtiler2Hajk.portal_backup_replace_portal': 'Replace portal pages',
    'Qtiler2Hajk.portal_backup_replace_maps': 'Replace published maps with same key',
    'Qtiler2Hajk.portal_backup_help': 'The backup JSON includes selected portal content and selected published map configurations. It does not include tile caches or QGIS project files.',
    'Qtiler2Hajk.portal_backup_exported': 'Portal backup exported.',
    'Qtiler2Hajk.portal_backup_imported': 'Portal backup imported ({n} maps).',
    'Qtiler2Hajk.portal_no_blocks_preview': 'Add sections to preview the page.',
    'Qtiler2Hajk.portal_no_users': 'No users found',
    'Qtiler2Hajk.portal_no_roles': 'No roles found',
    ...
    'Qtiler2Hajk.hiw.lead': 'Qtiler2Hajk embeds the Hajk web map viewer inside Qtiler and now also includes a visual portal/CMS for the public /Qtiler2Hajk/maps site. It downloads Hajk from a pinned GitHub release, lets you configure each published map graphically from QGIS, and lets admins build landing pages with text, cards, CTA blocks and selected maps.',
    ...
    'Qtiler2Hajk.hiw.arch.2': 'Per-map JSON files are stored under data/Qtiler2Hajk/maps/, while the portal/CMS state is stored separately and both are reloaded in place on edits — no server restart needed.',
    'Qtiler2Hajk.hiw.arch.3': 'The public site /Qtiler2Hajk/maps lists and renders portal pages, while /Qtiler2Hajk/maps/<name> still resolves directly to a published viewer. Reverse-proxy-safe routing keeps both entry points stable.',
    ...
    'Qtiler2Hajk.hiw.flow.3': 'Portal tab: create public pages visually, choose who can see each page or block, pick which published maps to feature, and choose whether each map is shown as a thumbnail, an embedded preview or an open-link card.',
    ...
    'Qtiler2Hajk.hiw.wfs.2': 'Tile and vector tile caches generated by Qtiler are served as background and overlay layers without re-tiling, while non-WFS vector content can still be rendered safely through WMS-driven published maps and portal thumbnails.',
    'Qtiler2Hajk.hiw.auth.title': '5. Authentication & visibility',
    'Qtiler2Hajk.hiw.auth.1': 'When QtilerAuth is active, its ACLs (public / authenticated / private) are enforced on maps, catalog responses and portal visibility. When QtilerAuth is not installed or not enabled, Qtiler2Hajk stays operational and degrades to fully public access.',
    ...
    'Qtiler2Hajk.hiw.security.2': 'Admin actions (install/uninstall, branding, publish/edit/delete maps, edit portal pages) remain admin-only when auth is enabled; with auth disabled, the public-facing routes stay readable without crashing the plugin.',
    'Qtiler2Hajk.hiw.security.3': 'Open source under MPL-2.0; auditable in plugins/Qtiler2Hajk/, including the map publisher, portal builder and access-fallback logic.'
  },
  es: {
    'Qtiler2Hajk.title': 'Qtiler2Hajk',
    'Qtiler2Hajk.subtitle': 'Instala Hajk desde GitHub, publica mapas visualmente y alimenta un portal público con o sin QtilerAuth.',
    'Qtiler2Hajk.how_title': 'Cómo funciona Qtiler2Hajk',
    'Qtiler2Hajk.how_intro': 'Qtiler2Hajk es el puente base entre Qtiler y Hajk: publica mapas web respaldados por QGIS y ahora también alimenta un portal/CMS visual para el sitio público /Qtiler2Hajk/maps sin salir de la consola de administración.',
    ...
    'Qtiler2Hajk.how_step_share': 'Compartir mapas y páginas — los visores publicados están disponibles directamente y la portada del portal vive en /Qtiler2Hajk/maps, donde los administradores pueden presentar mapas seleccionados como thumbnails, embebidos o tarjetas con enlace abierto.',
    'Qtiler2Hajk.how_step_brand': 'Personalizar — sube un logotipo, configura los controles de la barra y diseña páginas del portal con opciones de header, tarjetas, texto enriquecido y secciones de mapas. Los cambios se aplican en caliente sin reiniciar Qtiler.',
    ...
    'Qtiler2Hajk.portal_section': 'Páginas del portal',
    'Qtiler2Hajk.portal_desc': 'Crea páginas editoriales para el portal público de mapas, con secciones, mapas destacados y reglas de audiencia.',
    'Qtiler2Hajk.portal_add_page': 'Nueva página',
    'Qtiler2Hajk.portal_duplicate_page': 'Duplicar página',
    'Qtiler2Hajk.portal_save': 'Guardar portal',
    'Qtiler2Hajk.portal_open_page': 'Abrir página',
    'Qtiler2Hajk.portal_templates': 'Plantillas',
    'Qtiler2Hajk.portal_templates_help': 'Parte de un layout trabajado y luego adapta textos, mapas y bloques de noticias.',
    'Qtiler2Hajk.portal_apply_template': 'Aplicar plantilla',
    'Qtiler2Hajk.portal_pages_list': 'Páginas',
    'Qtiler2Hajk.portal_empty': 'Crea la primera página para convertir el portal de mapas en una portada editorial.',
    'Qtiler2Hajk.portal_page_title': 'Título de la página',
    'Qtiler2Hajk.portal_page_slug': 'Slug',
    'Qtiler2Hajk.portal_page_nav': 'Etiqueta de navegación',
    'Qtiler2Hajk.portal_page_summary': 'Resumen corto',
    'Qtiler2Hajk.portal_site_header_height': 'Altura del header',
    'Qtiler2Hajk.portal_site_header_font': 'Fuente del header',
    'Qtiler2Hajk.portal_site_header_color1': 'Color 1 del header',
    'Qtiler2Hajk.portal_site_header_color2': 'Color 2 del header',
    'Qtiler2Hajk.portal_site_header_text_color': 'Color del texto del header',
    'Qtiler2Hajk.portal_site_header_background_url': 'URL de imagen de fondo del header',
    'Qtiler2Hajk.portal_site_footer_text': 'Texto del footer',
    'Qtiler2Hajk.portal_site_footer_link_label': 'Etiqueta del enlace del footer',
    'Qtiler2Hajk.portal_site_footer_link_url': 'URL del enlace del footer',
    'Qtiler2Hajk.portal_site_footer_background_color': 'Color de fondo del footer',
    'Qtiler2Hajk.portal_site_footer_text_color': 'Color del texto del footer',
    'Qtiler2Hajk.portal_site_footer_link_color': 'Color del enlace del footer',
    'Qtiler2Hajk.portal_header_logo': 'URL del logo del header',
    'Qtiler2Hajk.portal_header_height': 'Altura del header',
    'Qtiler2Hajk.portal_show_header': 'Mostrar header',
    'Qtiler2Hajk.portal_visibility': 'Visibilidad de la página',
    'Qtiler2Hajk.portal_vis_public': 'Pública',
    'Qtiler2Hajk.portal_vis_authenticated': 'Usuarios autenticados',
    'Qtiler2Hajk.portal_vis_restricted': 'Usuarios / roles concretos',
    'Qtiler2Hajk.portal_users': 'Usuarios permitidos',
    'Qtiler2Hajk.portal_roles': 'Roles permitidos',
    'Qtiler2Hajk.portal_users_catalog': 'Listado de usuarios',
    'Qtiler2Hajk.portal_roles_catalog': 'Listado de roles',
    'Qtiler2Hajk.portal_show_in_nav': 'Mostrar en la navegación',
    'Qtiler2Hajk.portal_set_home': 'Usar como portada del portal',
    'Qtiler2Hajk.portal_blocks': 'Secciones',
    'Qtiler2Hajk.portal_blocks_help': 'Combina hero, texto, tarjetas, redes sociales y mapas para construir una landing profesional.',
    'Qtiler2Hajk.portal_add_block': 'Añadir sección',
    'Qtiler2Hajk.portal_preview': 'Vista previa',
    'Qtiler2Hajk.portal_preview_note': 'Vista escritorio',
    'Qtiler2Hajk.portal_fullscreen': 'Editor a pantalla completa',
    'Qtiler2Hajk.portal_device_desktop': 'Escritorio',
    'Qtiler2Hajk.portal_device_tablet': 'Tablet',
    'Qtiler2Hajk.portal_device_mobile': 'Móvil',
    'Qtiler2Hajk.portal_block_hero': 'Hero',
    'Qtiler2Hajk.portal_block_text': 'Texto',
    'Qtiler2Hajk.portal_block_cards': 'Tarjetas / noticias',
    'Qtiler2Hajk.portal_block_maps': 'Mapas destacados',
    'Qtiler2Hajk.portal_block_social': 'Redes sociales',
    'Qtiler2Hajk.portal_block_visibility': 'Visibilidad de la sección',
    'Qtiler2Hajk.portal_vis_inherit': 'Igual que la página',
    'Qtiler2Hajk.portal_intro': 'Texto introductorio',
    'Qtiler2Hajk.portal_body': 'Texto principal',
    'Qtiler2Hajk.portal_eyebrow': 'Eyebrow',
    'Qtiler2Hajk.portal_background_url': 'URL de imagen de fondo',
    'Qtiler2Hajk.portal_cta_label': 'Texto del botón',
    'Qtiler2Hajk.portal_cta_url': 'URL del botón',
    'Qtiler2Hajk.portal_layout': 'Diseño',
    'Qtiler2Hajk.portal_layout_grid': 'Cuadrícula',
    'Qtiler2Hajk.portal_layout_featured': 'Destacado',
    'Qtiler2Hajk.portal_map_display': 'Visualización del mapa',
    'Qtiler2Hajk.portal_map_display_thumbnail': 'Tarjetas con miniatura',
    'Qtiler2Hajk.portal_map_display_embed': 'Mapa integrado',
    'Qtiler2Hajk.portal_map_display_open': 'Abrir mapa',
    'Qtiler2Hajk.portal_map_profiles': 'Perfiles de mapa',
    'Qtiler2Hajk.portal_maps_catalog': 'Mapas publicados',
    'Qtiler2Hajk.portal_add_item': 'Añadir elemento',
    'Qtiler2Hajk.portal_item_title': 'Título del elemento',
    'Qtiler2Hajk.portal_item_text': 'Texto del elemento',
    'Qtiler2Hajk.portal_item_url': 'URL del enlace',
    'Qtiler2Hajk.portal_item_label': 'Etiqueta del enlace',
    'Qtiler2Hajk.portal_item_icon': 'Icono',
    'Qtiler2Hajk.portal_item_meta': 'Meta / fecha',
    'Qtiler2Hajk.portal_item_image': 'URL de imagen',
    'Qtiler2Hajk.portal_move_up': 'Subir',
    'Qtiler2Hajk.portal_move_down': 'Bajar',
    'Qtiler2Hajk.portal_edit_page': 'Editar pagina',
    'Qtiler2Hajk.portal_delete': 'Eliminar',
    'Qtiler2Hajk.portal_home_badge': 'Inicio',
    'Qtiler2Hajk.portal_hidden_badge': 'Oculta en navegación',
    'Qtiler2Hajk.portal_saved': 'Páginas del portal guardadas.',
    'Qtiler2Hajk.portal_backup_title': 'Exportar / importar copia del portal',
    'Qtiler2Hajk.portal_backup_pages': 'Páginas del portal a exportar',
    'Qtiler2Hajk.portal_backup_maps': 'Mapas publicados a exportar',
    'Qtiler2Hajk.portal_backup_export': 'Exportar JSON',
    'Qtiler2Hajk.portal_backup_import': 'Importar / restaurar JSON',
    'Qtiler2Hajk.portal_backup_replace_portal': 'Reemplazar páginas del portal',
    'Qtiler2Hajk.portal_backup_replace_maps': 'Reemplazar mapas publicados con la misma clave',
    'Qtiler2Hajk.portal_backup_help': 'El JSON incluye el contenido seleccionado del portal y las configuraciones de los mapas publicados seleccionados. No incluye caches de tiles ni archivos de proyecto QGIS.',
    'Qtiler2Hajk.portal_backup_exported': 'Copia del portal exportada.',
    'Qtiler2Hajk.portal_backup_imported': 'Copia del portal importada ({n} mapas).',
    'Qtiler2Hajk.portal_no_blocks_preview': 'Añade secciones para previsualizar la página.',
    'Qtiler2Hajk.portal_no_users': 'No se encontraron usuarios',
    'Qtiler2Hajk.portal_no_roles': 'No se encontraron roles',
    ...
    'Qtiler2Hajk.hiw.lead': 'Qtiler2Hajk integra el visor web Hajk dentro de Qtiler y ahora también incluye un portal/CMS visual para el sitio público /Qtiler2Hajk/maps. Descarga Hajk desde una release fija de GitHub, te permite configurar cada mapa publicado desde QGIS y deja a los administradores crear landing pages con texto, tarjetas, llamadas a la acción y mapas seleccionados.',
    'Qtiler2Hajk.hiw.vs.title': 'Qrigo vs Qtiler2Hajk',
    ...
    'Qtiler2Hajk.hiw.arch.2': 'Cada mapa se guarda como JSON en data/Qtiler2Hajk/maps/, mientras que el estado del portal/CMS se guarda por separado; ambos se recargan en caliente en cada edición, sin reiniciar el servidor.',
    'Qtiler2Hajk.hiw.arch.3': 'El sitio público /Qtiler2Hajk/maps lista y renderiza las páginas del portal, mientras que /Qtiler2Hajk/maps/<nombre> sigue resolviendo directamente a un visor publicado. El enrutado es seguro detrás de reverse proxy para ambos accesos.',
    ...
    'Qtiler2Hajk.hiw.flow.3': 'Pestaña Portal: crea páginas públicas de forma visual, elige quién puede ver cada página o bloque, selecciona qué mapas publicados destacar y decide si cada mapa se muestra como thumbnail, vista integrada o tarjeta con enlace abierto.',
    'Qtiler2Hajk.hiw.flow.4': 'Personaliza la experiencia con logo, visibilidad/altura del header y controles de la barra; después publica: los mapas quedan en /Qtiler2Hajk/maps/<nombre> y la portada del portal en /Qtiler2Hajk/maps.',
    ...
    'Qtiler2Hajk.hiw.maps.3': 'Marcadores, layouts de impresión, temas y el selector de mapas del portal se exponen automáticamente desde el mismo estado del plugin base.',
    ...
    'Qtiler2Hajk.hiw.wfs.2': 'Los cachés de tiles y vector tiles generados por Qtiler se sirven como capas de fondo y de overlay sin re-tilear, mientras que el contenido vectorial no WFS puede seguir mostrándose de forma segura mediante mapas publicados por WMS y thumbnails del portal.',
    'Qtiler2Hajk.hiw.auth.title': '5. Autenticación y visibilidad',
    'Qtiler2Hajk.hiw.auth.1': 'Cuando QtilerAuth está activo, sus ACL (public / authenticated / private) se aplican a mapas, respuestas del catálogo y visibilidad del portal. Cuando QtilerAuth no está instalado o no está habilitado, Qtiler2Hajk sigue funcionando y degrada a acceso completamente público.',
    ...
    'Qtiler2Hajk.hiw.security.2': 'Las acciones de administración (instalar/desinstalar, branding, publicar/editar/borrar mapas, editar páginas del portal) siguen siendo solo para admins cuando la auth está activa; con auth desactivada, las rutas públicas siguen siendo legibles sin que el plugin crashee.',
    'Qtiler2Hajk.hiw.security.3': 'Open source bajo MPL-2.0; auditable en plugins/Qtiler2Hajk/, incluyendo el publicador de mapas, el constructor del portal y la lógica de fallback de acceso.',
  },
  sv: {
    'Qtiler2Hajk.title': 'Hajk-brygga för Qtiler',
    'Qtiler2Hajk.subtitle': 'Installera Hajk från GitHub, publicera kartor visuellt och driva en publik portal med eller utan QtilerAuth.',
    'Qtiler2Hajk.how_title': 'Så fungerar Qtiler2Hajk',
    'Qtiler2Hajk.how_intro': 'Qtiler2Hajk är basbryggan mellan Qtiler och Hajk: den publicerar QGIS-baserade webbkartor och driver nu också en visuell portal/CMS för den publika sajten /Qtiler2Hajk/maps utan att du lämnar administrationskonsolen.',
    ...
    'Qtiler2Hajk.how_step_share': 'Dela kartor och sidor — publicerade visare nås direkt och portalens startsida finns på /Qtiler2Hajk/maps, där administratörer kan visa utvalda kartor som miniatyrer, inbäddningar eller öppna-länk-kort.',
    'Qtiler2Hajk.how_step_brand': 'Varumärkesanpassa — ladda upp en logotyp, konfigurera verktygsfältskontroller och bygg portalsidor med header-val, kort, rik text och kartsektioner. Ändringar laddas om direkt utan omstart av Qtiler.',
    ...
    'Qtiler2Hajk.portal_section': 'Portalsidor',
    'Qtiler2Hajk.portal_desc': 'Skapa redaktionella landningssidor för den publika kartportalen, med sektioner, utvalda kartor och målgruppsregler.',
    'Qtiler2Hajk.portal_add_page': 'Ny sida',
    'Qtiler2Hajk.portal_duplicate_page': 'Duplicera sida',
    'Qtiler2Hajk.portal_save': 'Spara portal',
    'Qtiler2Hajk.portal_open_page': 'Öppna sida',
    'Qtiler2Hajk.portal_templates': 'Mallar',
    'Qtiler2Hajk.portal_templates_help': 'Börja från en genomarbetad layout och anpassa sedan text, kartor och nyhetsblock.',
    'Qtiler2Hajk.portal_apply_template': 'Använd mall',
    'Qtiler2Hajk.portal_pages_list': 'Sidor',
    'Qtiler2Hajk.portal_empty': 'Skapa den första sidan för att göra kartportalen till en redaktionell startsida.',
    'Qtiler2Hajk.portal_page_title': 'Sidtitel',
    'Qtiler2Hajk.portal_page_slug': 'Slug',
    'Qtiler2Hajk.portal_page_nav': 'Navigationsetikett',
    'Qtiler2Hajk.portal_page_summary': 'Kort sammanfattning',
    'Qtiler2Hajk.portal_site_header_height': 'Headerhöjd',
    'Qtiler2Hajk.portal_site_header_font': 'Header-typsnitt',
    'Qtiler2Hajk.portal_site_header_color1': 'Headerfärg 1',
    'Qtiler2Hajk.portal_site_header_color2': 'Headerfärg 2',
    'Qtiler2Hajk.portal_site_header_text_color': 'Textfärg i header',
    'Qtiler2Hajk.portal_site_header_background_url': 'URL till headerns bakgrundsbild',
    'Qtiler2Hajk.portal_site_footer_text': 'Footertext',
    'Qtiler2Hajk.portal_site_footer_link_label': 'Länketikett i footer',
    'Qtiler2Hajk.portal_site_footer_link_url': 'Länk-URL i footer',
    'Qtiler2Hajk.portal_site_footer_background_color': 'Bakgrundsfärg i footer',
    'Qtiler2Hajk.portal_site_footer_text_color': 'Textfärg i footer',
    'Qtiler2Hajk.portal_site_footer_link_color': 'Länkfärg i footer',
    'Qtiler2Hajk.portal_header_logo': 'URL till headerlogotyp',
    'Qtiler2Hajk.portal_header_height': 'Headerhöjd',
    'Qtiler2Hajk.portal_show_header': 'Visa header',
    'Qtiler2Hajk.portal_visibility': 'Sidans synlighet',
    'Qtiler2Hajk.portal_vis_public': 'Publik',
    'Qtiler2Hajk.portal_vis_authenticated': 'Autentiserade användare',
    'Qtiler2Hajk.portal_vis_restricted': 'Specifika användare / roller',
    'Qtiler2Hajk.portal_users': 'Tillåtna användare',
    'Qtiler2Hajk.portal_roles': 'Tillåtna roller',
    'Qtiler2Hajk.portal_users_catalog': 'Användarlista',
    'Qtiler2Hajk.portal_roles_catalog': 'Rollista',
    'Qtiler2Hajk.portal_show_in_nav': 'Visa i navigationen',
    'Qtiler2Hajk.portal_set_home': 'Använd som portalens startsida',
    'Qtiler2Hajk.portal_blocks': 'Sektioner',
    'Qtiler2Hajk.portal_blocks_help': 'Kombinera hero, text, kort, sociala länkar och kartor för att bygga en professionell landningssida.',
    'Qtiler2Hajk.portal_add_block': 'Lägg till sektion',
    'Qtiler2Hajk.portal_preview': 'Förhandsvisning',
    'Qtiler2Hajk.portal_preview_note': 'Skrivbordsförhandsvisning',
    'Qtiler2Hajk.portal_fullscreen': 'Helskärmseditor',
    'Qtiler2Hajk.portal_device_desktop': 'Skrivbord',
    'Qtiler2Hajk.portal_device_tablet': 'Surfplatta',
    'Qtiler2Hajk.portal_device_mobile': 'Mobil',
    'Qtiler2Hajk.portal_block_hero': 'Hero',
    'Qtiler2Hajk.portal_block_text': 'Text',
    'Qtiler2Hajk.portal_block_cards': 'Kort / nyheter',
    'Qtiler2Hajk.portal_block_maps': 'Utvalda kartor',
    'Qtiler2Hajk.portal_block_social': 'Sociala länkar',
    'Qtiler2Hajk.portal_block_visibility': 'Sektionens synlighet',
    'Qtiler2Hajk.portal_vis_inherit': 'Samma som sidan',
    'Qtiler2Hajk.portal_intro': 'Ingress',
    'Qtiler2Hajk.portal_body': 'Brödtext',
    'Qtiler2Hajk.portal_eyebrow': 'Överrubrik',
    'Qtiler2Hajk.portal_background_url': 'URL till bakgrundsbild',
    'Qtiler2Hajk.portal_cta_label': 'Knapptext',
    'Qtiler2Hajk.portal_cta_url': 'Knapp-URL',
    'Qtiler2Hajk.portal_layout': 'Layout',
    'Qtiler2Hajk.portal_layout_grid': 'Rutnät',
    'Qtiler2Hajk.portal_layout_featured': 'Utvald',
    'Qtiler2Hajk.portal_map_display': 'Kartvisning',
    'Qtiler2Hajk.portal_map_display_thumbnail': 'Kort med miniatyr',
    'Qtiler2Hajk.portal_map_display_embed': 'Integrerad karta',
    'Qtiler2Hajk.portal_map_display_open': 'Öppna karta',
    'Qtiler2Hajk.portal_map_profiles': 'Kartprofiler',
    'Qtiler2Hajk.portal_maps_catalog': 'Publicerade kartor',
    'Qtiler2Hajk.portal_add_item': 'Lägg till post',
    'Qtiler2Hajk.portal_item_title': 'Posttitel',
    'Qtiler2Hajk.portal_item_text': 'Posttext',
    'Qtiler2Hajk.portal_item_url': 'Länk-URL',
    'Qtiler2Hajk.portal_item_label': 'Länketikett',
    'Qtiler2Hajk.portal_item_icon': 'Ikon',
    'Qtiler2Hajk.portal_item_meta': 'Meta / datum',
    'Qtiler2Hajk.portal_item_image': 'Bild-URL',
    'Qtiler2Hajk.portal_move_up': 'Upp',
    'Qtiler2Hajk.portal_move_down': 'Ner',
    'Qtiler2Hajk.portal_edit_page': 'Redigera sida',
    'Qtiler2Hajk.portal_delete': 'Ta bort',
    'Qtiler2Hajk.portal_home_badge': 'Start',
    'Qtiler2Hajk.portal_hidden_badge': 'Dold i navigation',
    'Qtiler2Hajk.portal_saved': 'Portalsidor sparade.',
    'Qtiler2Hajk.portal_no_blocks_preview': 'Lägg till sektioner för att förhandsvisa sidan.',
    'Qtiler2Hajk.portal_no_users': 'Inga användare hittades',
    'Qtiler2Hajk.portal_no_roles': 'Inga roller hittades',
    ...
    'Qtiler2Hajk.hiw.lead': 'Qtiler2Hajk bäddar in webbkartvyn Hajk i Qtiler och innehåller nu också en visuell portal/CMS för den publika sajten /Qtiler2Hajk/maps. Det laddar ner Hajk från en låst GitHub-release, låter dig konfigurera varje publicerad karta grafiskt från QGIS och låter administratörer bygga landningssidor med text, kort, call-to-action-block och utvalda kartor.',
    'Qtiler2Hajk.hiw.vs.title': 'Qrigo vs Qtiler2Hajk',
    ...
    'Qtiler2Hajk.hiw.arch.2': 'Varje karta sparas som JSON under data/Qtiler2Hajk/maps/, medan portalens/CMS:ets tillstånd sparas separat, och båda laddas om direkt vid ändringar utan omstart.',
    'Qtiler2Hajk.hiw.arch.3': 'Den publika sajten /Qtiler2Hajk/maps listar och renderar portalsidor, medan /Qtiler2Hajk/maps/<namn> fortfarande går direkt till en publicerad visare. Proxy-säker routing håller båda ingångarna stabila.',
    ...
    'Qtiler2Hajk.hiw.flow.3': 'Portal-fliken: skapa publika sidor visuellt, välj vem som får se varje sida eller block, välj vilka publicerade kartor som ska lyftas fram och om varje karta ska visas som miniatyr, inbäddad vy eller öppna-länk-kort.',
    'Qtiler2Hajk.hiw.flow.4': 'Varumärkesanpassa upplevelsen med logotyp, headerns synlighet/höjd och verktygsfältskontroller, och publicera sedan: kartor nås på /Qtiler2Hajk/maps/<namn> och portalens startsida på /Qtiler2Hajk/maps.',
    ...
    'Qtiler2Hajk.hiw.maps.3': 'Bokmärken, utskriftslayouter, teman och portalens kartväljare exponeras automatiskt från samma tillstånd i baspluginet.',
    ...
    'Qtiler2Hajk.hiw.wfs.2': 'Tile- och vector tile-cache som genereras av Qtiler serveras som bakgrunds- och overlay-lager utan ny tiling, medan icke-WFS-vektorinnehåll fortfarande kan visas säkert via WMS-baserade publicerade kartor och portalminiatyrer.',
    'Qtiler2Hajk.hiw.auth.title': '5. Autentisering och synlighet',
    'Qtiler2Hajk.hiw.auth.1': 'När QtilerAuth är aktivt tillämpas dess ACL:er (public / authenticated / private) på kartor, katalogsvar och portalens synlighet. När QtilerAuth inte är installerat eller inte är aktiverat fortsätter Qtiler2Hajk att fungera och degraderar till helt publik åtkomst.',
    ...
    'Qtiler2Hajk.hiw.security.2': 'Adminhandlingar (installera/avinstallera, branding, publicera/redigera/radera kartor, redigera portalsidor) förblir admin-begränsade när auth är aktivt; med auth avstängt fortsätter de publika rutterna att vara läsbara utan att pluginet kraschar.',
    'Qtiler2Hajk.hiw.security.3': 'Öppen källkod under MPL-2.0; granskbart i plugins/Qtiler2Hajk/, inklusive kartpubliceraren, portalbyggaren och logiken för åtkomstfallback.'
  }
};
...
QTWC_I18N.no = Object.assign({}, QTWC_I18N.sv, {
  ...
  'Qtiler2Hajk.subtitle': 'Installer Hajk fra GitHub, publiser kart visuelt og drift en offentlig portal med eller uten QtilerAuth.',
  ...
  'Qtiler2Hajk.portal_site_header_color2': 'Headerfarge 2',
  'Qtiler2Hajk.portal_site_header_text_color': 'Tekstfarge i header',
  'Qtiler2Hajk.portal_site_header_background_url': 'URL til bakgrunnsbilde i header',
  'Qtiler2Hajk.portal_site_footer_text': 'Footertekst',
  'Qtiler2Hajk.portal_site_footer_link_label': 'Lenketekst i footer',
  'Qtiler2Hajk.portal_site_footer_link_url': 'Lenke-URL i footer',
  'Qtiler2Hajk.portal_site_footer_background_color': 'Bakgrunnsfarge i footer',
  'Qtiler2Hajk.portal_site_footer_text_color': 'Tekstfarge i footer',
  'Qtiler2Hajk.portal_site_footer_link_color': 'Lenkefarge i footer'
});
...
QTWC_I18N.da = Object.assign({}, QTWC_I18N.sv, {
  ...
  'Qtiler2Hajk.subtitle': 'Installer Hajk fra GitHub, publicér kort visuelt og drift en offentlig portal med eller uden QtilerAuth.',
  ...
  'Qtiler2Hajk.portal_site_header_color2': 'Headerfarve 2',
  'Qtiler2Hajk.portal_site_header_text_color': 'Tekstfarve i header',
  'Qtiler2Hajk.portal_site_header_background_url': 'URL til baggrundsbillede i header',
  'Qtiler2Hajk.portal_site_footer_text': 'Footertekst',
  'Qtiler2Hajk.portal_site_footer_link_label': 'Linktekst i footer',
  'Qtiler2Hajk.portal_site_footer_link_url': 'Link-URL i footer',
  'Qtiler2Hajk.portal_site_footer_background_color': 'Baggrundsfarve i footer',
  'Qtiler2Hajk.portal_site_footer_text_color': 'Tekstfarve i footer',
  'Qtiler2Hajk.portal_site_footer_link_color': 'Linkfarve i footer'
});

QTWC_I18N.fi = Object.assign({}, QTWC_I18N.en, {
  'Qtiler2Hajk.title': 'Hajk-silta Qtilerille',
  'Qtiler2Hajk.subtitle': 'Asenna Hajk GitHubista, julkaise karttoja visuaalisesti ja ylläpidä julkista portaalia QtilerAuthin kanssa tai ilman sitä.',
  ...
  'Qtiler2Hajk.portal_site_header_color2': 'Ylätunnisteen väri 2',
  'Qtiler2Hajk.portal_site_header_text_color': 'Ylätunnisteen tekstiväri',
  'Qtiler2Hajk.portal_site_header_background_url': 'Ylätunnisteen taustakuvan URL',
  'Qtiler2Hajk.portal_site_footer_text': 'Alatunnisteen teksti',
  'Qtiler2Hajk.portal_site_footer_link_label': 'Alatunnisteen linkkiteksti',
  'Qtiler2Hajk.portal_site_footer_link_url': 'Alatunnisteen linkin URL',
  'Qtiler2Hajk.portal_site_footer_background_color': 'Alatunnisteen taustaväri',
  'Qtiler2Hajk.portal_site_footer_text_color': 'Alatunnisteen tekstiväri',
  'Qtiler2Hajk.portal_site_footer_link_color': 'Alatunnisteen linkkiväri'
});
...
function createDefaultPortalPage() {
  ...
  const title = `${t('Qtiler2Hajk.portal_page_title')} ${pageNumber}`;
...
function getPortalBlockTypeLabel(type) {
  return t(`Qtiler2Hajk.portal_block_${String(type || 'text').trim()}`);
}

function getPortalAccessLabel(access, inherit = false) {
  const key = inherit ? 'Qtiler2Hajk.portal_vis_inherit' : `Qtiler2Hajk.portal_vis_${String(access || 'public').trim()}`;
  return t(key);
}
...
function setPortalFullscreen(enabled) {
  ...
  if (portalToggleFullscreenBtn) {
    ...
    portalToggleFullscreenBtn.textContent = portalEditorFullscreen ? 'Exit fullscreen' : t('Qtiler2Hajk.portal_fullscreen');
  }
}

function getPortalPageUrl(page) {
  if (!page) return '/Qtiler2Hajk/portal';
  const slug = String(page.slug || '').trim();
  if (!slug) return '/Qtiler2Hajk/portal';
  return portalPagesState.homePageSlug && slug === portalPagesState.homePageSlug
    ? '/Qtiler2Hajk/portal'
    : `/Qtiler2Hajk/portal/${encodeURIComponent(slug)}`;
}
...
function renderPortalPageList() {
  ...
  if (!pages.length) {
    portalPagesList.innerHTML = `<p class="help">${escapeHtml(t('Qtiler2Hajk.portal_empty'))}</p>`;
  ...
  portalPagesList.innerHTML = pages.map((page, index) => {
    ...
    const badges = [
      portalPagesState.homePageSlug === page.slug ? t('Qtiler2Hajk.portal_home_badge') : '',
      page.showInNav === false ? t('Qtiler2Hajk.portal_hidden_badge') : ''
    ].filter(Boolean).join(' · ');
    return `
      <div class="portal-page-item ${isActive ? 'is-active' : ''}">
        ...
        <div class="portal-page-item__actions">
          <button type="button" class="button small is-info" data-portal-edit-window="${escapeHtml(page.id)}">${escapeHtml(t('Qtiler2Hajk.portal_edit_page'))}</button>
          <button type="button" class="button small" data-portal-move="up" data-portal-page-id="${escapeHtml(page.id)}">${escapeHtml(t('Qtiler2Hajk.portal_move_up'))}</button>
          <button type="button" class="button small" data-portal-move="down" data-portal-page-id="${escapeHtml(page.id)}">${escapeHtml(t('Qtiler2Hajk.portal_move_down'))}</button>
          <button type="button" class="button small" data-portal-delete-page="${escapeHtml(page.id)}">${escapeHtml(t('Qtiler2Hajk.portal_delete'))}</button>
        </div>
      </div>`;
  }).join('');
  updatePortalPublicLink();
...
function renderPortalRepeaterItems(block) {
  ...
  if (!items.length) return `<p class="help">${escapeHtml(t('Qtiler2Hajk.portal_no_blocks_preview'))}</p>`;
  return `<div class="portal-repeater">${items.map((item, index) => `
      <div class="portal-repeater__item">
        <div class="portal-block-card__actions">
          <button type="button" class="button small" data-portal-item-delete="${escapeHtml(block.id)}" data-item-index="${index}">${escapeHtml(t('Qtiler2Hajk.portal_delete'))}</button>
        </div>
        <div class="portal-block-card__grid">
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_title'))}</span><input class="input" type="text" value="${escapeHtml(item.title || '')}" data-portal-item-field="title" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_meta'))}</span><input class="input" type="text" value="${escapeHtml(item.meta || '')}" data-portal-item-field="meta" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_label'))}</span><input class="input" type="text" value="${escapeHtml(item.label || '')}" data-portal-item-field="label" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_url'))}</span><input class="input" type="text" value="${escapeHtml(item.url || '')}" data-portal-item-field="url" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_icon'))}</span><input class="input" type="text" value="${escapeHtml(item.icon || '')}" data-portal-item-field="icon" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_image'))}</span><input class="input" type="text" value="${escapeHtml(item.imageUrl || '')}" data-portal-item-field="imageUrl" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}" /></label>
        </div>
        <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_text'))}</span><textarea class="textarea" rows="3" data-portal-item-field="text" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}">${escapeHtml(item.text || '')}</textarea></label>
      </div>`).join('')}</div>`;
}
  ...
  return `<div class="portal-social-list">${items.map((item, index) => {
    ...
    return `
      <div class="portal-social-item">
        ...
        <label><span>${escapeHtml(t('Qtiler2Hajk.portal_block_social'))}</span><select class="input" data-portal-item-field="icon" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}">${getPortalSocialPlatformOptionsHtml(platform)}</select></label>
        <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_url'))}</span><input class="input" type="url" value="${escapeHtml(item.url || '')}" placeholder="https://" data-portal-item-field="url" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}" /></label>
        <label><span>${escapeHtml(t('Qtiler2Hajk.portal_item_label'))}</span><input class="input" type="text" value="${escapeHtml(label)}" data-portal-item-field="title" data-portal-block-id="${escapeHtml(block.id)}" data-item-index="${index}" /></label>
        <button type="button" class="button danger small" data-portal-item-delete="${escapeHtml(block.id)}" data-item-index="${index}">${escapeHtml(t('Qtiler2Hajk.portal_delete'))}</button>
      </div>`;
  }).join('')}</div>`;
}
...
function renderPortalBlocksList() {
  ...
  if (!blocks.length) {
    portalBlocksList.innerHTML = `<p class="help">${escapeHtml(t('Qtiler2Hajk.portal_no_blocks_preview'))}</p>`;
    return;
  }
  portalBlocksList.innerHTML = blocks.map((block, index) => {
    ...
    if (block.type === 'hero') {
      specific = `
        <div class="portal-block-card__grid">
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_eyebrow'))}</span><input class="input" type="text" value="${escapeHtml(block.eyebrow || '')}" data-portal-block-field="eyebrow" data-portal-block-id="${escapeHtml(block.id)}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_page_title'))}</span><input class="input" type="text" value="${escapeHtml(block.title || '')}" data-portal-block-field="title" data-portal-block-id="${escapeHtml(block.id)}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_background_url'))}</span><input class="input" type="text" value="${escapeHtml(block.backgroundUrl || '')}" data-portal-block-field="backgroundUrl" data-portal-block-id="${escapeHtml(block.id)}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_cta_label'))}</span><input class="input" type="text" value="${escapeHtml(block.ctaLabel || '')}" data-portal-block-field="ctaLabel" data-portal-block-id="${escapeHtml(block.id)}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_cta_url'))}</span><input class="input" type="text" value="${escapeHtml(block.ctaUrl || '')}" data-portal-block-field="ctaUrl" data-portal-block-id="${escapeHtml(block.id)}" /></label>
        </div>
        ${renderPortalRichEditorField('Qtiler2Hajk.portal_intro', 'subtitle', block.id, block.subtitle, 5)}`;
    } else if (block.type === 'text') {
      specific = `
        <div class="portal-block-card__grid">
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_page_title'))}</span><input class="input" type="text" value="${escapeHtml(block.title || '')}" data-portal-block-field="title" data-portal-block-id="${escapeHtml(block.id)}" /></label>
        </div>
        ${renderPortalRichEditorField('Qtiler2Hajk.portal_body', 'body', block.id, block.body, 8)}`;
      ...
      specific = `
        <div class="portal-block-card__grid">
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_page_title'))}</span><input class="input" type="text" value="${escapeHtml(block.title || '')}" data-portal-block-field="title" data-portal-block-id="${escapeHtml(block.id)}" /></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_layout'))}</span><select class="input" data-portal-block-field="layout" data-portal-block-id="${escapeHtml(block.id)}"><option value="grid" ${block.layout !== 'featured' ? 'selected' : ''}>${escapeHtml(t('Qtiler2Hajk.portal_layout_grid'))}</option><option value="featured" ${block.layout === 'featured' ? 'selected' : ''}>${escapeHtml(t('Qtiler2Hajk.portal_layout_featured'))}</option></select></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_map_display'))}</span><select class="input" data-portal-block-field="displayMode" data-portal-block-id="${escapeHtml(block.id)}"><option value="thumbnail" ${String(block.displayMode || 'thumbnail') === 'thumbnail' ? 'selected' : ''}>${escapeHtml(t('Qtiler2Hajk.portal_map_display_thumbnail'))}</option><option value="embed" ${String(block.displayMode || '') === 'embed' ? 'selected' : ''}>${escapeHtml(t('Qtiler2Hajk.portal_map_display_embed'))}</option><option value="open" ${String(block.displayMode || '') === 'open' ? 'selected' : ''}>${escapeHtml(t('Qtiler2Hajk.portal_map_display_open'))}</option></select></label>
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_map_profiles'))}</span><input class="input" type="text" value="${escapeHtml(toPortalCsv(block.profileKeys))}" data-value-kind="csv" data-portal-block-field="profileKeys" data-portal-block-id="${escapeHtml(block.id)}" /></label>
        </div>
        ${renderPortalRichEditorField('Qtiler2Hajk.portal_intro', 'intro', block.id, block.intro, 5)}
        <label><span>${escapeHtml(t('Qtiler2Hajk.portal_maps_catalog'))}</span><select class="input portal-multiselect" multiple size="8" data-portal-block-field="profileKeys" data-value-kind="multi-option" data-portal-block-id="${escapeHtml(block.id)}">${mapOptions.length ? mapOptions.map((item) => `<option value="${escapeHtml(item.value)}" ${Array.isArray(block.profileKeys) && block.profileKeys.includes(item.value) ? 'selected' : ''}>${escapeHtml(item.label)}</option>`).join('') : `<option value="">${escapeHtml(t('Qtiler2Hajk.no_profiles'))}</option>`}</select></label>`;
      ...
      specific = `
        ...
        <button type="button" class="button small info" data-portal-add-item="${escapeHtml(block.id)}">${escapeHtml(t('Qtiler2Hajk.portal_add_item'))}</button>`;
    } else {
      specific = `
        <div class="portal-block-card__grid">
          <label><span>${escapeHtml(t('Qtiler2Hajk.portal_page_title'))}</span><input class="input" type="text" value="${escapeHtml(block.title || '')}" data-portal-block-field="title" data-portal-block-id="${escapeHtml(block.id)}" /></label>
        ...
        <button type="button" class="button small" data-portal-add-item="${escapeHtml(block.id)}">${escapeHtml(t('Qtiler2Hajk.portal_add_item'))}</button>`;
    }
    return `
      <article class="portal-block-card">
        <div class="portal-block-card__head">
          ...
          <div class="portal-block-card__actions">
            ...
            <button type="button" class="button small" data-portal-block-move="up" data-portal-block-id="${escapeHtml(block.id)}">${escapeHtml(t('Qtiler2Hajk.portal_move_up'))}</button>
            <button type="button" class="button small" data-portal-block-move="down" data-portal-block-id="${escapeHtml(block.id)}">${escapeHtml(t('Qtiler2Hajk.portal_move_down'))}</button>
            <button type="button" class="button small" data-portal-block-delete="${escapeHtml(block.id)}">${escapeHtml(t('Qtiler2Hajk.portal_delete'))}</button>
          </div>
        </div>
        ${specific}
      </article>`;
...
function uploadPortalEditorImage(file) {
  ...
  return api('/plugins/Qtiler2Hajk/api/portal-assets/image', { method: 'POST', body })
    .then((payload) => {
...
function renderPortalPreview() {
  ...
  const page = getSelectedPortalPage();
  if (!page) {
    portalPreviewHost.innerHTML = `<div class="portal-preview__empty">${escapeHtml(t('Qtiler2Hajk.portal_empty'))}</div>`;
    return;
  }
  const blocks = Array.isArray(page.blocks) ? page.blocks : [];
  if (!blocks.length) {
    portalPreviewHost.innerHTML = `<div class="portal-preview__empty">${escapeHtml(t('Qtiler2Hajk.portal_no_blocks_preview'))}</div>`;
    return;
  }
  ...
  portalPreviewHost.innerHTML = `<div class="${previewClass}"><div class="portal-preview-frame__topbar"><span class="portal-preview-frame__dot"></span><span class="portal-preview-frame__dot"></span><span class="portal-preview-frame__dot"></span><span class="portal-preview-frame__url">${escapeHtml(getPortalPageUrl(page))}</span></div><div class="portal-preview">${previewHeader}${blocks.map((block) => {
    ...
    if (block.type === 'maps') {
      ...
      return `<section class="portal-preview__section"><h3>${escapeHtml(block.title || '')}</h3>${block.intro ? `<div class="portal-preview__lead portal-preview__richtext">${sanitizePortalRichHtml(block.intro)}</div>` : ''}<div class="portal-preview__maps ${block.layout === 'featured' ? 'is-featured' : ''} ${block.displayMode === 'embed' ? 'is-embed' : ''} ${block.displayMode === 'open' ? 'is-open' : ''}">${cards.map((item) => {
        const thumbUrl = item?.projectId ? `/plugins/Qtiler2Hajk/api/thumbnail/${encodeURIComponent(item.projectId)}` : '';
        if (block.displayMode === 'embed') {
          return `<div class="portal-preview__map portal-preview__map--embed"><div class="portal-preview__embed-shell"><iframe src="${escapeHtml(item?.launchUrl || '/Qtiler2Hajk/maps')}" loading="lazy" referrerpolicy="same-origin"></iframe></div><strong>${escapeHtml(item?.name || item?.profileKey || '')}</strong><p>${escapeHtml(item?.description || '')}</p></div>`;
        }
        if (block.displayMode === 'open') {
          return `<div class="portal-preview__map portal-preview__map--open"><strong>${escapeHtml(item?.name || item?.profileKey || '')}</strong><p>${escapeHtml(item?.description || '')}</p><a class="portal-preview__cta" href="${escapeHtml(item?.launchUrl || '/Qtiler2Hajk/maps')}" target="_blank" rel="noreferrer">${escapeHtml(t('Qtiler2Hajk.portal_map_display_open'))}</a></div>`;
        }
      ...
      }).join('') || `<div class="portal-preview__card">${escapeHtml(t('Qtiler2Hajk.no_profiles'))}</div>`}</div></section>`;
    }
...
function renderPortalEditor() {
  ...
  if (portalPageUsersCatalog) portalPageUsersCatalog.innerHTML = renderPortalMultiSelectOptions(getPortalAuthCatalog().users, page.visibility?.users, t('Qtiler2Hajk.portal_no_users'));
  if (portalPageRoles) portalPageRoles.value = toPortalCsv(page.visibility?.roles);
  if (portalPageRolesCatalog) portalPageRolesCatalog.innerHTML = renderPortalMultiSelectOptions(getPortalAuthCatalog().roles, page.visibility?.roles, t('Qtiler2Hajk.portal_no_roles'));
...
function updatePortalPageField(field, rawValue) {
  ...
  if (field === 'visibility.users' && portalPageUsersCatalog) {
    portalPageUsersCatalog.innerHTML = renderPortalMultiSelectOptions(getPortalAuthCatalog().users, page.visibility?.users, t('Qtiler2Hajk.portal_no_users'));
  }
  if (field === 'visibility.roles' && portalPageRolesCatalog) {
    portalPageRolesCatalog.innerHTML = renderPortalMultiSelectOptions(getPortalAuthCatalog().roles, page.visibility?.roles, t('Qtiler2Hajk.portal_no_roles'));
  }
  renderPortalPageList();
  renderPortalPreview();
  updatePortalPublicLink();
...
async function loadPortalPages() {
  const payload = await api('/plugins/Qtiler2Hajk/api/portal-pages');
...
async function savePortalPages(options = {}) {
  ...
  const payload = await api('/plugins/Qtiler2Hajk/api/portal-pages', { method: 'POST', body: portalPagesState });
  if (options.refresh !== false) loadPortalPagesState(payload);
  if (!options.silent) addLog(t('Qtiler2Hajk.portal_saved'), 'ok');
}
...
portalExportBackupBtn?.addEventListener('click', async () => {
  ...
  try {
    ...
    const backup = await api('/plugins/Qtiler2Hajk/api/portal-backup/export', {
      method: 'POST',
      body: { pageIds, mapKeys }
    });
    const stamp = new Date().toISOString().slice(0, 19).replace(/[:T]/g, '-');
    downloadJsonFile(backup, `qtiler2origo-portal-backup-${stamp}.json`);
    addLog(t('Qtiler2Hajk.portal_backup_exported'), 'ok');
  } catch (err) {
    addLog(t('Qtiler2Hajk.log_error', { msg: err.message }), 'error');
  } finally {
...
portalImportBackupInput?.addEventListener('change', async () => {
  ...
  try {
    ...
    const result = await api('/plugins/Qtiler2Hajk/api/portal-backup/import', {
      method: 'POST',
      body: {
        backup,
    ...
    addLog(t('Qtiler2Hajk.portal_backup_imported', { n: result?.maps?.length || 0 }), 'ok');
  } catch (err) {
    addLog(t('Qtiler2Hajk.log_error', { msg: err.message }), 'error');
  } finally {
