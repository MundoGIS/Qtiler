...
(function () {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      "guide.section5Title": "Service matrix and commercial plugins",
      ...
      "guide.plugins.item.auth": "QtilerAuth: authentication, role-based access, and protected project sharing.",
      "guide.plugins.item.search": "ProjectSearch: searchable endpoints and UI helpers for attribute-based search.",
      "guide.plugins.item.qrigo": "Qrigo: Origo-oriented integration helpers and publishing shortcuts.",
      "guide.plugins.item.wmscache": "WmsCache: external WMS source caching and acceleration.",
      "guide.plugins.item.vectortiles": "VectorTiles: MBTiles generation plus TileJSON/MVT endpoints for vector delivery.",
      ...
      "guide.section6Title": "Best practices",
    ...
    es: {
      ...
      "guide.section5Title": "Matriz de servicios y plugins comerciales",
      ...
      "guide.plugins.item.auth": "QtilerAuth: autenticación, control por roles y compartición protegida de proyectos.",
      "guide.plugins.item.search": "ProjectSearch: endpoints de búsqueda y ayudas de interfaz para búsquedas por atributos.",
      "guide.plugins.item.qrigo": "Qrigo: integraciones orientadas a Origo y atajos de publicación.",
      "guide.plugins.item.wmscache": "WmsCache: caché y aceleración de fuentes WMS externas.",
      "guide.plugins.item.vectortiles": "VectorTiles: generación MBTiles y endpoints TileJSON/MVT para entrega vectorial.",
      ...
      "guide.section6Title": "Buenas prácticas",
    ...
    sv: {
      ...
      "guide.section5Title": "Tjänstmatris och kommersiella plugins",
      ...
      "guide.plugins.item.auth": "QtilerAuth: autentisering, rollbaserad åtkomst och skyddad projektdelning.",
      "guide.plugins.item.search": "ProjectSearch: sökbara endpoints och UI-stöd för attributsökning.",
      "guide.plugins.item.qrigo": "Qrigo: Origo-orienterade integrationshjälpmedel och publiceringsgenvägar.",
      "guide.plugins.item.wmscache": "WmsCache: cache och acceleration för externa WMS-källor.",
      "guide.plugins.item.vectortiles": "VectorTiles: MBTiles-generering samt TileJSON/MVT-endpoints för vektorleverans.",
      ...
      "guide.section6Title": "Bästa praxis",
